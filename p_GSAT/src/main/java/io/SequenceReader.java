...
public class SequenceReader {
	...
	/**
	 * Overload taking an input file Parses one AB1 file (the only one or the
	 * next one in the list) into a sequence. If possible, deletes the first
	 * entry of the list. Note: There's no method to read in several files at
	 * once, because the files is analyzed one by one.
	 * 
	 * @throws IOException
	 * @throws IllegalSymbolException
	 * 
	...
	/**
	 * Returns a list of all AB1 files in the path that was set via
	 * configurePath()
	 * 
	 * @return
	 * @author Kevin
