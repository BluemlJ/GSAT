...
public class ConsoleIO {
	...
	/**
	 * WARNING: Highly experimental and still untested Needs To be testet in
	 * builded Verion (as JAR) WARNING: Black Magic incoming Should clear
	 * Console OS independently
	 */
	...
	/**
	 * Asks the User to type in a Number in range from min to max (Integer) and
	 * returns it as int Queston will be repeated if input is not a Number or to
	 * big or to small Warning: an Error is printen when min and max are
	 * switched
	 * 
	 * @param message
	 *            the message displayed to the User
