 ...
 * different tables and this abstract entry can actually be split with its parts 
 * being distributed among those tables (while making sure that it is 
 * possible to combine the data again).
 * 
 * @author Ben Kohr
 *
 */
public class DatabaseEntry {
     ...
     * @author Ben Kohr
     */
    public DatabaseEntry(int id, String gene, String primer, 
    ...
    /**
     * This method converts a given sequence into a list of database entries to be stored
     * and returns them.
     * 
