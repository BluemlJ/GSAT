...
public class ConfigHandler {
	...
	/**
	 * The path where the config file is stored. This is set to the OS dependent
	 * home directory.
	 */
	...
	/**
	 * The active researcher which will be written in analysis results. This is
	 * set to "-" as a placeholder to avoid null pointer.
	 */
	private static String researcher = "-";

	/**
	 * This is a list of all known researchers which is used for selecting an
	 * active researcher. Set to "-" to avoid null pointer.
	 */
	...
	/**
	 * The server address for the database, set to the address from the TU
	 * Darmstadt database.
	 */
	private static String dbUrl = "130.83.37.145";

	/**
	 * The username for the database, set to the username from the TU Darmstadt
	 * database.
	 */
	private static String dbUser = "gsatadmin";

	/**
	 * The password for the database, "none" is a placeholder which can be
	 * replaced by setting the correct password from the configure database GUI.
	 */
	...
	/**
	 * this parameter sets the minimal quality to start a sequence. This can be
	 * changed by the user. The default value is 30.
	 * 
	...
	/**
	 * this parameter sets the minimal quality to end a sequence. This can be
	 * changed by the user. The default value is 25.
	 * 
	 * @see io.ConfigHandler
	 * @see gui.ParameterWindow
	 */
	...
	/**
	 * Number of Nucleotides which will be used for the average Quality
	 * calculations. This can be changed by user.
	 * 
	 * @see io.ConfigHandler
	 * @see gui.ParameterWindow
	 */
	...
	/**
	 * This variable represents how many good quality nucleotides are needed
	 * before the sequence start gets detected. Changing this may cause tests to
	 * fail. This can be changed by user.
	 */
	...
	/**
	 * The char which is used to represent a file that has been manually
	 * checked.
	 */
	public static final char MANUAL_CHECKED_YES = 'y';

	/**
	 * The char which is used to represent a file that has not been manually
	 * checked.
	 */
	public static final char MANUAL_CHECKED_NO = 'n';

	/**
	 * Reads the content of the configuration file and stores its values
	 * locally.
	 * 
	 * @throws IOException
	 *             An error during file handling occured.
	 * @throws UnknownConfigFieldException
	 *             The config file contains unknown fields.
	 * @throws ConfigNotFoundException
	 *             The config file can not be found.
	...
	/**
	 * Reads the content of the configuration file in the given path and stores
	 * its values locally.
	 * 
	 * @param path
	 *            The folder in which the config.txt is.
	 * @throws IOException
	 *             An error during file handling occured.
	 * @throws UnknownConfigFieldException
	 *             The config file contains unknown fields.
	...
	/**
	 * This method creates a new configuration file in the user home directory
	 * in a folder named gsat.
	 * 
	 * @throws IOException
	 * @author Lovis Heindrich
	 */
	...
	/**
	 * Writes a researcher in the researcher list. May overwrite an existing
	 * researcher.
	 * 
	 * @param researcher
	 *            The name of the researcher.
	 * @param i
	 *            The array index where the new researcher will be added.
	 * @author Lovis Heindrich
	 */
	...
	/**
	 * Adds a new researcher to the list. Does not write it directly to
	 * configuration file.
	 * 
	 * @param name
	 *            The name of the new researcher.
	 * @author Lovis Heindrich
	 */
	...
	/**
	 * Deletes a researcher from the list. Does not write it directly to the
	 * configuration file.
	 * 
	 * @param name
	 *            The name of the researcher which will be deleted.
	 * @author Lovis Heindrich
	 */
