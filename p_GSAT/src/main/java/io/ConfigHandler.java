...
public class ConfigHandler {
	...
	/**
	 * read the content of the configuration file in the given path and store
	 * its values locally
	 * 
	 * @param path
	 *            the folder in which the config.ini is
	 * @throws IOException
	 * @throws UnknownConfigFieldException
	 * @throws ConfigNotFoundException
	 */
	...
	/**
	 * create a new configuration file in the user home directory in a folder
	 * named gsat
	 * 
	 * @throws IOException
	 * 
	...
	/**
	 * deletes a researcher from the list does not write it directly to
	 * configuration file
	 * 
	 * @param name
	 *            name of the researcher which will be deleted
	 */
