...
public class GUIUtils {
	...
	/**
	 * This method initialize the choiceBox and adds all Gene which are stored
	 * locally in the Genes.txt
	 * 
	 * @param genes
	 *            the choiceBox to initialize
	...
	public static Pair<Boolean, Text> initializeResearchers(ChoiceBox<String> dropdown) {
		try {
			...
			return new Pair<Boolean, Text>(false, getRedText("Reading researchers from config.txt was unsuccessful\n"));
		}
	 ...
	 * 
	 * @param sourcepath
	 *            path to .ab1 file or folder
	 * @param GeneID
	 *            ID of the Gene in the Choicebox.
	 * @return a Pair or Boolean, which indicates if the method was successful
	 *         and a String, which can printed in the infoarea.
	 * @throws DissimilarGeneException
	 */
	public static Pair<Boolean, Text> runAnalysis(String sourcepath, String GeneID, String resultname, ProgressBar bar,
			TextFlow tf) throws DissimilarGeneException {
		...
		for (File file : sequences.first) {
			...
			try {
				...
				tf.getChildren()
						.add(getRedText("Calculation of complementary sequence unsuccessful, analysing stops\n"));
			...
			toAnalyse
					.setTrimPercentage(QualityAnalysis.percentageOfTrimQuality(lengthBeforeTrimmingQuality, toAnalyse));
			...
			try {
				...
				tf.getChildren().add(
						getRedText("Mutation analysis was unsuccessful because of error in " + file.getName() + "\n"));
				return new Pair<Boolean, Text>(success, new Text(report.toString()));
			}
	...
	/**
	 * This method opens a DirectoryChooser to set the destinationpath. Later
	 * results and reports will be saved here.
	 * 
	 * @param destination
	 *            Textfield, to place path.
	 * @param sourcepath
	 *            path from the source field
	...
	/**
	 * This method opens a DirectoryChooser to set the sourcepath. In this path,
	 * there should be some .ab1 files.
	 * 
	 * @param source
	 *            Textfield, to place path.
	 * @return reportpair of boolean (indicates success) and report String
	...
	public static Pair<Boolean, Text> setSourceFolder(TextField source) {
		...
		if (result.get() == buttonTypeOne) {
			...
			return new Pair<Boolean, Text>(success, getRedText("The action to set a source folder was cancelled\n"));
		}
	...
	/**
	 * This method gets all ab1 files from an given path. It sorts them to ab1
	 * files and other
	 * 
	 * @param source
	 *            the path to check about .abi-Files
	 * @return two lists in form of a Pair. The .ab1 files and the not usuable
	 *         files.
	 */
	private static Pair<LinkedList<File>, LinkedList<File>> getSequencesFromSourceFolder(String source) {
	...
	private static Pair<AnalysedSequence, Pair<Boolean, Text>> readSequenceFromFile(File file) {
		Text report = getRedText("Failure with: " + file.getAbsolutePath() + ".\n This file might be corrupted.\n");
		boolean success = false;
		...
		try {
			...
			return new Pair<AnalysedSequence, Pair<Boolean, Text>>(SequenceReader.convertFileIntoSequence(file), ret);
	...
	public static void setColorOnNode(Node node, Color color) {
		...
		case GREEN:
			...
			normalColor1 = "rgb(185, 246, 202)";
			normalColor2 = "rgb(185, 246, 202)";
			hoverColor1 = "rgb(165, 226, 182)";
			hoverColor2 = "rgb(165, 226, 182)";
			pressedColor1 = "rgb(145, 206, 162)";
			pressedColor2 = "rgb(145, 206, 162)";
		...
		case RED:
			...
			normalColor1 = "rgb(255, 158, 128)";
			normalColor2 = "rgb(255, 158, 128)";
			hoverColor1 = "rgb(235,138,108)";
			hoverColor2 = "rgb(235,138,108)";
			pressedColor1 = "rgb(215,118,88)";
			pressedColor2 = "rgb(215,118,88)";
			break;
		case BLUE:
			/*
			 * normalColor1 = "rgb(177,177,255)"; normalColor2 =
			 * "rgb(125,125,255)"; hoverColor1 = "rgb(200,200,255)"; hoverColor2
			 * = "rgb(164,164,255)"; pressedColor1 = "rgb(159,159,229)";
			 * pressedColor2 = "rgb(112,112,229)";
			 */

			normalColor1 = "rgb(130, 177, 255)";
			normalColor2 = "rgb(130, 177, 255)";
			hoverColor1 = "rgb(120, 157, 235)";
			hoverColor2 = "rgb(120, 157, 235)";
			pressedColor1 = "rgb(100,137,215)";
			pressedColor2 = "rgb(100,137,215)";
			break;
		}

		String normalStyle = "-fx-background-color: radial-gradient(center 50% -39%, radius 200%, " + normalColor1
				+ " 45%, " + normalColor2 + " 50%); -fx-border-color: gray; -fx-border-radius: 3px;";
		String hoverStyle = "-fx-background-color: radial-gradient(center 50% -39%, radius 200%, " + hoverColor1
				+ " 45%, " + hoverColor2 + " 50%); -fx-border-color: gray; -fx-border-radius: 3px;";
		String pressedStyle = "-fx-background-color: radial-gradient(center 50% -39%, radius 200%, " + pressedColor1
	...
	/*
	 * 
	 * case GREEN: normalColor1 = "rgb(184,239,54)"; normalColor2 =
	 * "rgb(128,200,1)"; hoverColor1 = "rgb(205,243,114)"; hoverColor2 =
	 * "rgb(166,216,77)"; pressedColor1 = "rgb(184,239,54)"; pressedColor2 =
	 * "rgb(128,200,1)"; break; case RED: normalColor1 = "rgb(251,117,117)";
	 * normalColor2 = "rgb(255,40,40)"; hoverColor1 = "rgb(252,158,158)";
	 * hoverColor2 = "rgb(255,104,104)"; pressedColor1 = "rgb(251,117,117)";
	 * pressedColor2 = "rgb(255,40,40)"; break; case BLUE: normalColor1 =
	 * "rgb(60,204,204)"; normalColor2 = "rgb(50,153,255)"; hoverColor1 =
	 * "rgb(118,219,219)"; hoverColor2 = "rgb(90,173,255)"; pressedColor1 =
