...
public class GUIUtils {
	 ...
	 */
	public static LinkedList<Text> runAnalysis(LinkedList<AnalysedSequence> sequences, String geneId, String resultname,
		...
		for (AnalysedSequence analysedSequence : sequences) {
			...
			try {
				...
				return wrap("Mutation analysis was unsuccessful because of error in " + analysedSequence.getFileName()
						+ "\n", resultingLines, true);
			}
	...
	/**
	 * This methods sets a color on a given node object and also provides
	 * EventHandlers to change the color slighly when the mouse is above, clicks
	 * or leaves the node. The available colors can be found in
	 * {@link ButtonColor}.
	 * 
	 * @param button
	 *            The button to be colored
	 * @param color
	 *            A ButtonColor element to specify the desired color scheme.
	 */
