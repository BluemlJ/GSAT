...
/**
 * Main interface for database connection. Used to push and pull data from
 * database.
 * 
...
public class DatabaseWindow extends Application implements javafx.fxml.Initializable {
	...
	/**
	 * Toggle button to upload/download results. This includes sequences and the
	 * referenced genes and researchers.
	 */
	@FXML
	...
	/**
	 * Toggle button to upload/download all data, this includes all sequences,
	 * genes and primers.
	 */
	@FXML
	...
	/**
	 * Datepicker to select a start date. This is used to only download data
	 * which was created after this date.
	 */
	@FXML
	private DatePicker startDate;

	/**
	 * Datepicker to select a end date. This is used to only download data which
	...
	/**
	 * String containing a message which will be shown when a local file could
	 * not be written.
	 */
	...
	/**
	 * String containing a message which will be shown when the upload
	 * succeeded.
	 */
	private static final String UPLOAD_SUCCESS = "Upload to database complete.";

	/**
	 * String containing a message which will be shown when the download
	 * succeeded.
	 */
	...
	/**
	 * Downloads results specified by the optional parameters date, gene and
	 * researcher. Saves them as a csv file to the in destField specified path.
	 * 
	 * @throws SQLException
	 ...
	 *             Path for saving the file is missing.
	 * @throws IOException
	...
	/**
	 * Uploads all sequences in the in destField specified folder. Also uploads
	 * necessary genes and researchers.
	 * 
	 * @throws IOException
	 *             Error while reading local files.
	 * @throws SQLException
	 *             Error while executing sql commands.
	 * @throws DatabaseConnectionException
	 *             Error while connecting to database.
