...
public class Main {
	...
	private static void startConsoleVersion() {
		...
		//TODO REALE DO IT
		String strGen = null;
		String srtGenName = null;
		boolean noGen = true;
		while (noGen) {
		  try {
		      strGen = ConsoleIO.readLine("Please give me the gene sequence");
		      noGen = false;
		      srtGenName = ConsoleIO.readLine("Please give the gene name");
		    } catch (IOException e2) {
		      noGen = true;
		    }  
        }
		
		Gene gene = new Gene(strGen, 0, srtGenName, "");
