...
public class ConsoleVersion {
	...
	/**
	 * runs the complete analysis pipeline for a single sequence and adds a
	 * database entry for the sequence
	 * 
	 * @param activeSequence
	 * @param gene
	 * @param file
	...
	/**
	 * reads genes from file and returns the correct gene genes must be in a txt
	 * file named genes.txt in the same folder as the ab1 files if genes.txt can
	 * not be found it asks the user for a gene
	 * 
	 * @return
	 * @author Lovis Heindrich
	 * 
