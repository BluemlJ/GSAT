...
public interface ComparableOntology extends Ontology, Comparable, Changeable {
  ...
  public static final ChangeType TERM = new ChangeType("This ontology's terms have changed",
      "org.biojavax.ontology.ComparableOntology", "TERM");
  public static final ChangeType TRIPLE = new ChangeType("This ontology's triples have changed",
      "org.biojavax.ontology.ComparableOntology", "TRIPLE");
  public static final ChangeType DESCRIPTION =
      new ChangeType("This ontology's description has changed",
          "org.biojavax.ontology.ComparableOntology", "DESCRIPTION");
  ...
  /**
   * Clears out all the terms and populates the ontology with the contents of the set passed. The
   * terms should be ComparableTerms.
   * 
  ...
  /**
   * Looks for a term with the given name and returns it. If it couldn't be found, then it creates
   * it, adds it to the ontology, then returns it.
   * 
  ...
  /**
   * Looks for a triple with the given subject object and predicate and returns it. If it couldn't
   * be found, then it creates it, adds it to the ontology, then returns it.
   * 
  ...
  /**
   * Looks for a term with the same name as the given term and returns it. If it couldn't be found,
