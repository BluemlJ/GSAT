...
public interface ComparableTerm extends Term, RankedCrossRefable, Comparable, Changeable {
  ...
  public static final ChangeType IDENTIFIER = new ChangeType("This term's identifier has changed",
      "org.biojavax.ontology.ComparableTerm", "IDENTIFIER");
  public static final ChangeType OBSOLETE = new ChangeType("This term's obsolescence has changed",
      "org.biojavax.ontology.ComparableTerm", "OBSOLETE");
  public static final ChangeType DESCRIPTION = new ChangeType("This term's description has changed",
      "org.biojavax.ontology.ComparableTerm", "DESCRIPTION");
  public static final ChangeType RANKEDCROSSREF =
      new ChangeType("This term's ranked crossrefs have changed",
          "org.biojavax.ontology.ComparableTerm", "RANKEDCROSSREF");
  ...
  /**
   * Checks to see if this term is obsolete. As the column in the database is nullable, this value
   * is a Boolean object instead of a boolean simple type. Hence it may also be null.
   * 
