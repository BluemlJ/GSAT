...
public class SimpleComparableTriple extends AbstractChangeable implements ComparableTriple {
  ...
  /**
   * Creates a new instance of SimpleComparableTriple. All parameters are required and immutable.
   * 
   ...
   */
  SimpleComparableTriple(ComparableOntology ontology, ComparableTerm subject, ComparableTerm object,
  ...
  /**
   * {@inheritDoc} Triples are sorted in order of ontology, subject, object, and finally predicate.
   */
  ...
  /**
   * {@inheritDoc} Triples are equal only if they are from the same ontology and share the same
  ...
  public boolean equals(Object o) {
    ...
    // Normal comparison
    Triple them = (Triple) o;
    return (this.ontology.equals(them.getOntology()) && this.subject.equals(them.getSubject())
        && this.object.equals(them.getObject()) && this.predicate.equals(them.getPredicate()));
  }
   ...
   * {@inheritDoc}
   */
  public void addDescriptor(ComparableTerm desc)
   ...
   * {@inheritDoc}
   */
  public boolean removeDescriptor(ComparableTerm desc)
      throws IllegalArgumentException, ChangeVetoException {
    if (desc == null) throw new IllegalArgumentException("Cannot have null descriptor");
    boolean result;
    if (!this.hasListeners(ComparableTriple.DESCRIPTOR)) {
