...
public class SimpleComparableTerm extends AbstractChangeable implements ComparableTerm {
  ...
  SimpleComparableTerm(ComparableOntology ontology, String name, Object[] synonyms) {
    ...
    if (synonyms != null && synonyms.length != 0) this.synonyms.addAll(Arrays.asList(synonyms));
  }
  ...
  /**
   * {@inheritDoc} Two terms are equal if they are in the same ontology and share the same name.
   */
  ...
  /**
   * {@inheritDoc} Synonyms are stored in the database as the results of a toString() operation on
   * each synonym object. This doesn't happen until it reaches the database though, so if you are
   * not using a database, don't worry about it.
   */
  ...
  public void setDescription(String description) throws ChangeVetoException {
    if (!this.hasListeners(ComparableTerm.DESCRIPTION)) {
      ...
      ChangeEvent ce =
          new ChangeEvent(this, ComparableTerm.DESCRIPTION, description, this.description);
  ...
  /**
   * {@inheritDoc} Form: "ontology:name [obsolete]" where [obsolete] is optional
   */
  ...
  public void setIdentifier(String identifier) throws ChangeVetoException {
    if (!this.hasListeners(ComparableTerm.IDENTIFIER)) {
      ...
      ChangeEvent ce =
          new ChangeEvent(this, ComparableTerm.IDENTIFIER, identifier, this.identifier);
