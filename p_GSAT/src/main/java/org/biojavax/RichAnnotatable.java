...
public interface RichAnnotatable extends Annotatable {
  ...
  /**
   * Returns the set of notes associated with this object. Would normally delegate call to internal
   ...
   * Would normally delegate call to internal RichAnnotation instance.
   * 
   * @param notes the set of Note objects to replace the existing ones with.
   * @throws ChangeVetoException if the set is null or contains any objects that are not Note
   *         objects.
   * @see Note
   */
