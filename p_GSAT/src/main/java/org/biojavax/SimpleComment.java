...
public class SimpleComment extends AbstractChangeable implements Comment {
  ...
  public void setRank(int rank) throws ChangeVetoException {
    ...
    if (!this.hasListeners(Comment.RANK)) {
      ...
      ChangeEvent ce =
          new ChangeEvent(this, Comment.RANK, new Integer(rank), new Integer(this.rank));
  ...
  /**
   * {@inheritDoc} Two comments are defined as equal if their text values and rankings are
   * identical.
   */
  ...
  /**
   * {@inheritDoc} Comments are ordered first by their rank, then by a string comparison of their
   * text values.
   */
