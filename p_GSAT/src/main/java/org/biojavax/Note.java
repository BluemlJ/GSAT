...
/**
 * Note is a generic class intended to hold a term describing the note, a value to associate with
 * that term, and a rank. It is a generic representation of the various qualifier_value tables in
 * BioSQL. It is used inside RichAnnotation objects to represent annotations.
 * 
...
public interface Note extends Comparable, Changeable {
  ...
  public static final ChangeType TERM =
      new ChangeType("This note's term has changed", "org.biojavax.Note", "TERM");
  public static final ChangeType RANK =
      new ChangeType("This note's rank has changed", "org.biojavax.Note", "RANK");
  public static final ChangeType VALUE =
      new ChangeType("This note's value has changed", "org.biojavax.Note", "VALUE");
