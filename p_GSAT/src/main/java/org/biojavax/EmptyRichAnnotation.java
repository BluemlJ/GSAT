...
public class EmptyRichAnnotation extends Unchangeable implements RichAnnotation, Serializable {
  ...
  /**
   * {@inheritDoc} There are no properties in the Empty RichAnnotation object. Calling this will
   * return null.
   */
  ...
  /**
   * {@inheritDoc} There are no notes in the Empty RichAnnotation object. Calling this will return
   * null.
   */
  ...
  public void setProperty(Object key, Object value) throws ChangeVetoException {
    throw new ChangeVetoException(
        "You can not add properties to the Empty RichAnnotation object: " + key + " -> " + value);
  }
   ...
   * {@inheritDoc}
   * 
   * @return true if and only if o is an instance of this class or a descendant.
   */
