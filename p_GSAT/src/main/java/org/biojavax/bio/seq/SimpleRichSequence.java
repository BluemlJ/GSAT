...
public class SimpleRichSequence extends ThinRichSequence {
  ...
  /**
   * Creates a new instance of SimpleRichSequence. Note the use of Double for seqversion, which
   ...
   */
  public SimpleRichSequence(Namespace ns, String name, String accession, int version,
      SymbolList symList, Double seqversion) {
