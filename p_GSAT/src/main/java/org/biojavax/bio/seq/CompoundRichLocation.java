...
/**
 * An implementation of RichLocation which covers multiple locations, but on the same strand of the
 * same (optionally circular) sequence.
 * 
...
public class CompoundRichLocation extends SimpleRichLocation implements RichLocation {
  ...
  /**
   * Constructs a CompoundRichLocation from the given set of members, with the default term of
   * "join". Note that you really shouldn't use this if you are unsure if your members set contains
   * overlapping members. Use RichLocation.Tools.construct() instead. The members collection must
   * only contain Location instances. Any that are not RichLocations will be converted using
   * RichLocation.Tools.enrich(). All members must come from the same strand of the same sequence
   * with the same circular length.
   * 
  ...
  /**
   * Constructs a CompoundRichLocation from the given set of members. Note that you really shouldn't
   * use this if you are unsure if your members set contains overlapping members. Use
   * RichLocation.Tools.construct(members) instead. The members collection must only contain
   * Location instances. Any that are not RichLocations will be converted using
  ...
  /**
   * {@inheritDoc} Passes the call on to each of its members in turn.
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS THE EMPTY ANNOTATION NOTE SET
   */
  ...
  /**
   * {@inheritDoc} RECURSIVELY APPLIES CALL TO ALL MEMBERS
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS FALSE
   */
  ...
  /**
   * {@inheritDoc} Recursively applies this call to all members.
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS NULL
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS SELF
   */
  ...
  /**
   * {@inheritDoc} Recursively translates all members of this location.
   */
  ...
  /**
   * {@inheritDoc} Recursively applies this call to all members. If passed a Location which is not a
   * RichLocation, it converts it first using RichLocation.Tools.enrich().
   * 
   * @see RichLocation.Tools
   * @return true if an only if one of the members of this <code>Location</code> wholey contains
   *         <code>l</code>.
   */
  ...
  /**
   * {@inheritDoc} If passed a Location which is not a RichLocation, it converts it first using
   * RichLocation.Tools.enrich(). The resulting location may or may not be a compound location. If
   * it is a compound location, its contents will be a set of simple locations. Regions that overlap
   * will be merged into a single location.
   * 
   * @see RichLocation.Tools
   * @return a <code>CompoundLocation</code> if the components of the union cannot be merged else a
   *         <code>SimpleRichLocation</code>
   */
   ...
   * {@inheritDoc} If passed a Location which is not a RichLocation, it converts it first using
   * RichLocation.Tools.enrich(). The resulting location may or may not be a compound location. If
   * it is a compound location, its contents will be a set of simple locations.
   * 
   * @return a <code>CompoundLocation</code> if there is more than one region of intersection that
  ...
  /**
   * {@inheritDoc} This function concatenates the symbols of all its child locations.
   * <p>
   * The most obvious application of this method to a <code>CompoundRichLocation</code> is the
   * contatenation of the components of a gene with multiple exons.
   */
  ...
  /**
   * {@inheritDoc} Compound locations are only equal to other Locations if all their components are
   * equal.
   */
  ...
  /**
   * {@inheritDoc} Form: "term:[location,location...]"
   */
