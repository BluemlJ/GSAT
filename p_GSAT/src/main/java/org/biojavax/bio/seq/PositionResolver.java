...
public interface PositionResolver {
  ...
  public static class MaximalResolver implements PositionResolver {
    ...
    /**
     * {@inheritDoc} ALWAYS RETURNS s.getStart()
     */
    ...
    /**
     * {@inheritDoc} ALWAYS RETURNS e.getEnd()
     */
  ...
  public static class MinimalResolver implements PositionResolver {
    ...
    /**
     * {@inheritDoc} ALWAYS RETURNS s.getEnd()
     */
    public int getMin(Position s) {
      return s.getEnd();
    }
    ...
    /**
     * {@inheritDoc} ALWAYS RETURNS e.getStart()
     */
    public int getMax(Position e) {
      return e.getStart();
    }
  ...
  /**
   * The minimal resolver returns the base which provides the average range, halfway between maximal
   * and minimal.
   */
  public static class AverageResolver implements PositionResolver {

    /**
     * {@inheritDoc} ALWAYS RETURNS s.getStart()+s.getEnd() / 2
     */
    public int getMin(Position s) {
      int min = s.getStart();
      int max = s.getEnd();
    ...
    /**
     * {@inheritDoc} ALWAYS RETURNS e.getStart()+e.getEnd() / 2
     */
    public int getMax(Position e) {
      int min = e.getStart();
      int max = e.getEnd();
