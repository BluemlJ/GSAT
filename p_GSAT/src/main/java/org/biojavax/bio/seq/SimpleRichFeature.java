...
public class SimpleRichFeature extends AbstractChangeable implements RichFeature {
   ...
   */
  public SimpleRichFeature(FeatureHolder parent, Feature.Template templ)
  ...
  Set getLocationSet() {
    ...
    // System.out.println("SimpleRichFeature.getLocationSet-featureId:"+featureId+",
    // locsSet:"+locsSet+", getLocation:"+getLocation());
    ...
    // System.out.println("SimpleRichFeature.getLocationSet-featureId:"+featureId+",
    // locsSet:"+locsSet+", this:"+this+", getLocation:"+getLocation());
  ...
  private final static void setTerm(final Collection theCollection, final ComparableTerm theTerm) {
    ...
    while (l.hasNext()) {
      ...
      try {
        ...
        throw new RuntimeException("SimpleRichFeature.setTerm-unable to set term <" + theTerm
  ...
  void setLocationSet(Set locs) throws ChangeVetoException {
    ...
    // System.out.println("SimpleRichFeature.SETLocationSet-featureId:"+featureId+", locs:"+locs+",
    // location:"+location);
  }
  ...
  public void setRank(int rank) throws ChangeVetoException {
    if (!this.hasListeners(RichFeature.RANK)) {
      ...
      ChangeEvent ce =
          new ChangeEvent(this, RichFeature.RANK, new Integer(rank), new Integer(this.rank));
  ...
  public void setLocation(Location loc) throws ChangeVetoException {
    ...
    // System.out.println("SimpleRichFeature.setLocation-location:"+location+(location instanceof
    // RichLocation?", term:"+((RichLocation) location).getTerm():""));
  }
   ...
   * unpredictable.
   */
  public void setFeatureRelationshipSet(Set<RichFeatureRelationship> relationships)
  ...
  public Feature createFeature(Feature.Template ft) throws BioException, ChangeVetoException {
    ...
    this.addFeatureRelationship(new SimpleRichFeatureRelationship(this, f,
  ...
  /**
   * {@inheritDoc} Features are equal when they have the same rank, parent, type, and source.
   * Features which are not instance of RichFeature are given a rank of zero.
   */
  ...
  /**
   * {@inheritDoc} Features are sorted first by rank, then parent, type, and source. If both parents
   * are not comparable then this part of the sorting is skipped. Features which are not instance of
   * RichFeature are given a rank of zero.
   */
  public int compareTo(Object o) {
    ...
    if (this.parent instanceof Comparable && them.getParent() instanceof Comparable
  ...
  public String toString() {
    return "(#" + this.rank + ") " + this.parent + ":" + this.getType() + "," + this.getSource()
        + "(" + this.location + ")";
  }
