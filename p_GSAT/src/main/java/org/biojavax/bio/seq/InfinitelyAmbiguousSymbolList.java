...
/**
 * A symbol list that is <code>Integer.MAX_VALUE</code>long, never gives index out of bounds and
 * always returns ambiguity symbols for everything.
 * 
...
public class InfinitelyAmbiguousSymbolList implements SymbolList {
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS AN ITERATOR OVER A SINGLE AMBIGUITY SYMBOL
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS <code>Integer.MAX_VALUE</code>
   */
  public int length() {
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS THE AMBIGUITY SYMBOL REPRESENTED AS A STRING
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS THE CORRECT LENGTH STRING MADE UP OF AMBIGUITY SYMBOLS
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS THE AMBIGUITY SYMBOL
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS A LIST CONTAINING THE AMBIGUITY SYMBOL
   */
  public List toList() {
