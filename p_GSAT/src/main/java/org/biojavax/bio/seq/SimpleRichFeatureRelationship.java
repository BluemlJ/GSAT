 ...
 *
 */
public class SimpleRichFeatureRelationship extends AbstractChangeable
    implements
   ...
   */
  public SimpleRichFeatureRelationship(RichFeature object, RichFeature subject, ComparableTerm term,
      int rank) {
  ...
  public void setRank(int rank) throws ChangeVetoException {
    if (!this.hasListeners(RichFeatureRelationship.RANK)) {
      ...
      ChangeEvent ce = new ChangeEvent(this, RichFeatureRelationship.RANK, new Integer(rank),
  ...
  /**
   * {@inheritDoc} Relations are compared first by rank, then object, subject, then finally term.
   */
  ...
  /**
   * {@inheritDoc} Relations are equal if their objects, subjects and terms are equal.
   */
  public boolean equals(Object obj) {
    ...
    return (this.object.equals(them.getObject()) && this.subject.equals(them.getSubject())
  ...
  /**
   * {@inheritDoc} Form: "(#rank) term(object,subject)"
   */
  public String toString() {
    return "(#" + this.rank + ") " + this.getTerm() + "(" + this.getObject() + ","
        + this.getSubject() + ")";
  }
