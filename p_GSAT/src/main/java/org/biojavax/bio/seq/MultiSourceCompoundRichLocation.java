...
/**
 * An implementation of RichLocation which possibly covers multiple locations, on different strands,
 * different circular lengths, or different sequences.
 * 
...
public class MultiSourceCompoundRichLocation extends CompoundRichLocation implements RichLocation {
  ...
  /**
   * Constructs a MultiSourceCompoundRichLocation from the given set of members, with the default
   * term of "join". Note that you really shouldn't use this if you are unsure if your members set
   * contains overlapping members. Use RichLocation.Tools.construct() instead. The members
   * collection must only contain Location instances. Any that are not RichLocations will be
  ...
  /**
   * Constructs a MultiSourceCompoundRichLocation from the given set of members. Note that you
   * really shouldn't use this if you are unsure if your members set contains overlapping members.
   * Use RichLocation.Tools.construct(members) instead. The members collection must only contain
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS ZERO
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS COMBINED LENGTH OF MEMBERS
   */
  public int getMax() {
    return this.size;
  }
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS A POINT POSITION AT POINT 1
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS A POINT POSITION AT POINT EQUIVALENT TO COMBINED LENGTH OF MEMBERS
   */
