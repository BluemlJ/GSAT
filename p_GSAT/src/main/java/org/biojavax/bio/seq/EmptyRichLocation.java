...
/**
 * An Empty implementation of RichLocation. This class is intended to act as a place holder for
 * events like the intersection of two locations that do not overlap so that null need not be
 * returned.
 * 
...
public class EmptyRichLocation extends Unchangeable implements RichLocation {
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS THE UNKNOWN STRAND
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS THE EMPTY POSITION
   */
  ...
  /**
   * {@inheritDoc} This method is ignored in the empty location because positions are fixed an
   * cannot be modified.
   */
  public void setPositionResolver(PositionResolver p) {} // ignore

  /**
   * {@inheritDoc} ALWAYS RETURNS THE EMPTY SET ITERATOR
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS PASSED LOCATION
   */
  ...
  /**
   * {@inheritDoc} This method is ignored in the empty location because there is nothing to resolve.
   */
  public void setCrossRefResolver(CrossReferenceResolver r) {}

  /**
   * {@inheritDoc} ALWAYS RETURNS THE EMPTY SYMBOL LIST
   */
  ...
  /**
   * {@inheritDoc} Empty Rich Locations only match other Empty Rich Locations
   */
  ...
  /**
   * {@inheritDoc} Empty Rich Locations return 0 when compared to other Empty ones, or -1 otherwise.
   */
  ...
  /**
   * {@inheritDoc} ALWAYS RETURNS "empty"
   */
