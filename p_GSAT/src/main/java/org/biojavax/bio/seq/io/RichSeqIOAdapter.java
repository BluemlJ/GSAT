...
/**
 * This class implements all methods of RichSeqIOListener and takes no action. It should be
 * overridden to implement custom listeners that only listen for a small subset of events.
 *
...
public class RichSeqIOAdapter implements RichSeqIOListener {
  ...
  /**
   * This is a dummy feature. It is returned by the method {@link #getCurrentFeature()
   * getCurrentFeature()}. Access is provided so you can override it.
   */
