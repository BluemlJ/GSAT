...
public class HashedFastaIterator implements RichSequenceIterator {
  ...
  public HashedFastaIterator(BufferedInputStream is, Alphabet alpha, Namespace ns)
      throws BioException {
...
class MyRichSeqIOListener implements RichSeqIOListener {
  ...
  public void endSequence() throws ParseException {
    ...
    currentSequence = new SimpleRichSequence(ns, name, ac, version, symbolList, sversion);
