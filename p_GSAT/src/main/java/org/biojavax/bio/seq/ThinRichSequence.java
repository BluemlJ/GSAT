...
/**
 * A simple implementation of RichSequence. It has no sequence data, and delegates to a
 * RichSequenceHandler to do sequence handling.
 * 
...
public class ThinRichSequence extends SimpleBioEntry implements RichSequence {
  ...
  /**
   * Creates a new instance of ThinRichSequence. Note the use of Double for seqversion, which
   * indicates that it is nullable.
   * 
   ...
   */
  public ThinRichSequence(Namespace ns, String name, String accession, int version, Alphabet alpha,
      Double seqversion) {
  ...
  public void setSeqVersion(Double seqVersion) throws ChangeVetoException {
    if (!this.hasListeners(RichSequence.SYMLISTVERSION)) {
      ...
      ChangeEvent ce =
          new ChangeEvent(this, RichSequence.SYMLISTVERSION, seqVersion, this.symListVersion);
  ...
  public void setCircular(boolean circular) throws ChangeVetoException {
    if (!this.hasListeners(RichSequence.CIRCULAR)) {
      ...
      ChangeEvent ce = new ChangeEvent(this, RichSequence.CIRCULAR, new Boolean(circular),
  ...
  void setCircularChar(final String isHiddenChar) throws ChangeVetoException {
    setCircular(isHiddenChar != null || (isHiddenChar != null && isHiddenChar.length() > 0));// any
                                                                                             // character
                                                                                             // will
                                                                                             // set
  }
