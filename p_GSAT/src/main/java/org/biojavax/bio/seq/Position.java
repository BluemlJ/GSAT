...
public interface Position {
  ...
  /**
   * A symbol representing a position that falls in between two bases, eg. 2^3 falls somewhere in
   * the gap between 2 and 3.
   */
  public static final String BETWEEN_BASES = "^";

  /**
   * A symbol representing a position that occupies a single base somewhere in a range, eg. 5.10
   * falls on some base between 5 and 10.
   */
  ...
  /**
   * Returns the beginning of the range of bases this base could lie in. If this position is a
   * single position, then start=end.
   * 
  ...
  /**
   * Returns the end of the range of bases this base could lie in. If this position is a single
   * position, then start=end.
   * 
  ...
  /**
   * Returns the type of this position if it is not a point/single position. Types are usually
   * BETWEEN_BASES or IN_RANGE but could be any string value.
   * 
