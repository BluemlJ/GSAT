...
public class SimpleNCBITaxon extends AbstractChangeable implements NCBITaxon {
  ...
  /**
   * Creates a new instance of SimpleNCBITaxon based on the given taxon ID. It may not be null, else
  ...
  public void addName(String nameClass, String name)
    ...
    if (!this.hasListeners(NCBITaxon.NAMES)) {
      ...
      ChangeEvent ce = new ChangeEvent(this, NCBITaxon.NAMES, name,
  ...
  public void setMitoGeneticCode(Integer mitoGeneticCode) throws ChangeVetoException {
    if (!this.hasListeners(NCBITaxon.MITOGENETICCODE)) {
      ...
      ChangeEvent ce =
          new ChangeEvent(this, NCBITaxon.MITOGENETICCODE, mitoGeneticCode, this.mitoGeneticCode);
   ...
   * name: scientific or if there are no scientific names at all, the empty string.
   * 
  ...
  public final void setTaxonHidden(final boolean isTaxonHidden) throws ChangeVetoException {
    if (!this.hasListeners(HIDDEN)) {
      ...
      final ChangeEvent ce = new ChangeEvent(this, HIDDEN, new Boolean(isTaxonHidden),
          new Boolean(this.isTaxonHidden));
  ...
  void setTaxonHiddenChar(final String isHiddenChar) throws ChangeVetoException {
    setTaxonHidden(isHiddenChar != null || (isHiddenChar != null && isHiddenChar.length() > 0));// any
                                                                                                // character
                                                                                                // will
                                                                                                // set
  }
  ...
  /**
   * {@inheritDoc} Form: "taxid:[name,name...]"
   */
