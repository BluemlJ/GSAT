...
public interface NCBITaxon extends Comparable, Changeable {
  ...
  public static final ChangeType NAMES =
      new ChangeType("This taxon's names have changed", "org.biojavax.bio.taxa.NCBITaxon", "NAMES");
  public static final ChangeType PARENT = new ChangeType("This taxon's parent has changed",
      "org.biojavax.bio.taxa.NCBITaxon", "PARENT");
  public static final ChangeType NODERANK = new ChangeType("This taxon's node rank has changed",
      "org.biojavax.bio.taxa.NCBITaxon", "NODERANK");
  public static final ChangeType GENETICCODE = new ChangeType(
      "This taxon's genetic code has changed", "org.biojavax.bio.taxa.NCBITaxon", "GENETICCODE");
  public static final ChangeType MITOGENETICCODE =
      new ChangeType("This taxon's mito genetic code has changed",
          "org.biojavax.bio.taxa.NCBITaxon", "MITOGENETICCODE");
  public static final ChangeType LEFTVALUE = new ChangeType("This taxon's left value has changed",
      "org.biojavax.bio.taxa.NCBITaxon", "LEFTVALUE");
  public static final ChangeType RIGHTVALUE = new ChangeType("This taxon's right value has changed",
      "org.biojavax.bio.taxa.NCBITaxon", "RIGHTVALUE");

  public static final ChangeType HIDDEN =
      new ChangeType("This taxon's visibility in genbank hierarchy has changed",
          "org.biojavax.bio.taxa.NCBITaxon", "HIDDEN");

  /**
   * Use this to define scientific names for things. There should usually only be one scientific
  ...
  /**
   * Use this to define equivalent names for things. There can be as many equivalent names as you
   * like.
   */
  ...
  /**
   * Gets the NCBI taxon ID. This is never null and is immutable, as otherwise we would have no way
   * of distinguishing between various taxa. It should be set by the constructor of an
   * implementation.
   * 
  ...
  /**
   * Returns the name of this taxon entry in the form: scientific (common) or if there is no common
   * name: scientific
   * 
  ...
  /**
   * Returns the taxonomy hierarchy of this taxon entry in the form: least specific; more specific;
   * ...; most specific. It follows the chain up the tree as far as it can, and will stop at the
   * first one it comes to that returns null for getParentNCBITaxID()
   * 
   * @return the display name as described above.
   */
