...
public class SimpleBioEntryRelationship extends AbstractChangeable implements BioEntryRelationship {
  ...
  /**
   * Creates a new instance of SimpleBioEntryRelationship. None of the parameters may be null, and
   * all are immutable except the rank.
   * 
  ...
  /**
   * {@inheritDoc} A relationship is compared first by rank, then object, subject, and term. If
  ...
  /**
   * {@inheritDoc} Relationships are equal if they share the same rank, object, subject and term. If
  ...
  public boolean equals(Object obj) {
    ...
    int ourRank = (this.getRank() == null ? 0 : this.rank.intValue());
    int theirRank = (them.getRank() == null ? 0 : them.getRank().intValue());
    return (this.subject.equals(them.getSubject()) && this.object.equals(them.getObject())
        && this.term.equals(them.getTerm()) && ourRank == theirRank);
  }
  ...
  /**
   * {@inheritDoc} Form is "(#rank) term(object,subject)"
   */
