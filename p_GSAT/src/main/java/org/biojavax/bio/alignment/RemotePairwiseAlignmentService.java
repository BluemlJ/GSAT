...
/**
 * This interface specifies minimal information needed to execute a pairwise alignment on a remote
 * service.
 * 
...
public interface RemotePairwiseAlignmentService {
  ...
  /**
   * Doing the actual analysis on the instantiated service using specified parameters and the
   * RichSequence object
   * 
   * @throws BioException
   */
  ...
  /**
   * Doing the actual analysis on the instantiated service using specified parameters on the string
  ...
  /**
   * Getting the actual alignment results from this instantiated service for a given ID with
   * specific formatting parameters held in a RemotePairwiseAlignmentOutputProperties-implemented
   * object.
   * 
   ...
   * @throws BioException
   */
  public InputStream getAlignmentResults(String rid, RemotePairwiseAlignmentOutputProperties out)
      throws BioException;
}
