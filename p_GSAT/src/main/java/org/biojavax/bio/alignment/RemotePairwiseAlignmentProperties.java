...
/**
 * RemotePairwiseAlignmentProperties is a interface that contains the barest of methods for setting
 * and getting Alignment properties.
 * 
 * Ideally, one would extend this class if creating a service by creating wrapper methods that
 * actually call either getAlignementOption or setAlignementOption with specific values for
 * parameter names and checking values for options.
 * 
