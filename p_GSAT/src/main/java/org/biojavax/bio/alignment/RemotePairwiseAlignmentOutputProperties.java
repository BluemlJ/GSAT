...
/**
 * RemotePairwiseAlignmentOutputProperties: the simplest representation of an object capable of
 * holding output formatting informations to be fed to a RemotePairwiseAlignmentService-implemented
 * object.
 * 
