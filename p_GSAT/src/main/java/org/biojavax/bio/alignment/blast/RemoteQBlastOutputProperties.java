...
/**
 * The actual implementation of the RemotePairwiseAlignmentOutputProperties interface for the QBlast
 * service.
 * 
...
public class RemoteQBlastOutputProperties implements RemotePairwiseAlignmentOutputProperties {
  ...
  /**
   * This constructor build the parameters for the default output of the GET command sent to the
   * QBlast service. Here are the default values:
   * 
   * FORMAT_TYPE = Text; ALIGNMENT_VIEW = Pairwise DESCRIPTIONS = 100; ALIGNMENTS = 100;
   * 
   */
  ...
  /**
   * Method that returns the alignment output format for this actual RemoteQBlastOutputProperties
   * object
   * 
   ...
   * 
   * @param rf :an enum from RemoteQBlastOutputFormat
   * @throws BioException if the enum is neither of
   *         RemoteQBlastOutputFormat.PAIRWISE/QUERY_ANCHORED/QUERY_ANCHORED_NO_IDENTITIES/FLAT_QUERY_ANCHORED
  ...
  /**
   * A method that simply returns the number of descriptions fetched with this
  ...
  /**
   * A method that simply returns the number of alignments fetched with this
   * RemoteQBlastOutputProperties object.
   * 
  ...
  /**
   * Method that returns any value associated to any key for this RemoteQBlastOutputProperties
   * object.
   * 
   */
  public String getOutputOption(String o) throws BioException {
    if (out.containsKey(o)) {
      ...
      throw new BioException(
          "The key named " + o + " is not set in this RemoteQBlastOutputProperties object");
    }
  }
