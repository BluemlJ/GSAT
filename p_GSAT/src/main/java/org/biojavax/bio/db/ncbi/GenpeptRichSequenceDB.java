...
/**
 * This class contains functions accessing Peptide sequences in Genpept format. It adds methods to
...
public class GenpeptRichSequenceDB extends AbstractRichSequenceDB implements RichSequenceDBLite {
  ...
  public RichSequence getRichSequence(String id) throws BioException, IllegalIDException {
    try {
      ...
      SymbolTokenization rParser = ProteinTools.getTAlphabet().getTokenization("token"); // get
                                                                                         // SymbolTokenization
