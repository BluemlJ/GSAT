...
/**
 * This class relates to the bioentry table in BioSQL. It holds everything you need to define a
 * non-sequence bearing bioentry.
 * 
...
public interface BioEntry extends RichAnnotatable, RankedCrossRefable, Comparable, Changeable {
  ...
  public static final ChangeType IDENTIFIER = new ChangeType(
      "This bioentry's identifier has changed", "org.biojavax.bio.BioEntry", "IDENTIFIER");
  public static final ChangeType DESCRIPTION = new ChangeType(
      "This bioentry's description has changed", "org.biojavax.bio.BioEntry", "DESCRIPTION");
  public static final ChangeType DIVISION = new ChangeType("This bioentry's division has changed",
      "org.biojavax.bio.BioEntry", "DIVISION");
  public static final ChangeType TAXON =
      new ChangeType("This bioentry's taxon has changed", "org.biojavax.bio.BioEntry", "TAXON");
  public static final ChangeType SEQVERSION = new ChangeType(
      "This bioentry's sequence version has changed", "org.biojavax.bio.BioEntry", "SEQVERSION");
  public static final ChangeType RANKEDCROSSREF = new ChangeType(
      "This bioentry's ranked crossrefs changed", "org.biojavax.bio.BioEntry", "RANKEDCROSSREF");
  public static final ChangeType RANKEDDOCREF = new ChangeType(
      "This bioentry's ranked docrefs changed", "org.biojavax.bio.BioEntry", "RANKEDDOCREF");
  public static final ChangeType COMMENT =
      new ChangeType("This bioentry's comments changed", "org.biojavax.bio.BioEntry", "COMMENT");
  public static final ChangeType RELATIONS = new ChangeType(
      "This bioentry's relations have changed", "org.biojavax.bio.BioEntry", "RELATIONS");

  /**
   * Returns the namespace of this bioentry. The namespace is supposed to be an immutable property
  ...
  /**
   * Returns the name of this bioentry. The name is supposed to be an immutable property set by the
   * constructor.
   * 
  ...
  /**
   * Returns the accession of this bioentry. The accession is supposed to be an immutable property
   * set by the constructor.
   * 
  ...
  /**
   * Gets the version of this bioentry. Bioentries with no versions return 0. The version is
   * supposed to be immutable and set only by the constructor.
   * 
  ...
  /**
   * Returns a set of all bioentrydocrefs associated with this bioentry. This set is not mutable. If
   * no docrefs are associated, you will get back an empty set.
   * 
  ...
  /**
   * Returns a set of all comments associated with this bioentry. This set is not mutable. If no
   * comments are associated, you will get back an empty set.
   * 
  ...
  /**
   * Returns a set of all relationships associated with this bioentry. This set is not mutable. If
   * no relationships are associated, you will get back an empty set.
   * 
