...
public interface RichAnnotation extends Annotation {
  ...
  /**
   * Adds a note to this annotation. Must not be null. If the note is already in the annotation,
   * nothing happens.
   * 
  ...
  /**
   * Removes a note from this annotation. Must not be null. If the note wasn't in the annotation,
   * nothing happens.
   * 
  ...
  /**
   * Returns true if the given note exists in this annotation. The lookup is done using the term and
   * rank of the note.
   * 
  ...
  /**
   * Clears the notes from this annotation and replaces them with those from the given set. The set
   * cannot be null.
   * 
   ...
   * 
   * @param key either a <code>String</code> identifier of a term from the default ontology or a
   *        <code>ComparableTerm</code>
   * @return an array of matching <code>Notes</code> in order of rank or an empty array if there are
   *         no matches. No implementation should ever return null!
   * @see Note
