...
public interface Organism extends Changeable {
  ...
  /**
   * This method allows to set the fitness of this organism to the specified value. Generally this
   * will be an array, which in the most cases contains just a single entry. In cases where we want
   * to have multi-objective optimization we may want to make use of a more general fitness array
   * with mutliple entries.
   *
   * @param fitness
   */
  ...
  /**
   * Returns the current fitness of this organism. This is an array. Note that in the most cases
   * this array may only contain one single value, but for multi-objective optimization it is
   * necessary to store multiple fitness values.
   *
   ...
   * @throws ChangeVetoException if the Chromosome collection of the Organism is unchangable
   */
