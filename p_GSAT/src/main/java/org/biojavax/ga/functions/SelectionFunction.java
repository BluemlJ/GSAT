...
public interface SelectionFunction {
  ...
  /**
   * Selects a <code>Population</code> of <code>Organisms</code> for replication based on their
   * fitness.
   *
   ...
   * @throws ChangeVetoException if the function attempts to change the population and it is vetoed.
   */
  ...
  public final class Threshold implements SelectionFunction {
    ...
    /**
     * Selects individuals whose fitness (as determined by the <code>FitnessFunction</code>) is more
     * than the cutoff. Removes those that aren't.
     *
     * @param pop the <code>Population</code> to select from.
     * @param genAlg the parent <code>GeneticAlgorithm</code>
  ...
  public final class SelectAll implements SelectionFunction {
    ...
    /**
     * @throws UnsupportedOperationException as there is no <code>FitnessFunction</code> for this
     *         class
     ...
     * @throws ChangeVetoException you Cannot set the <code>FitnessFunction</code> of a
