...
/**
 * <p>
 * A Selection function that determines the proportion of individuals in a new population
 * proportionally to their fitness. The population size is not allowed to grow. Individuals are
 * randomly selected for replication, those with greater fitness tend to replicate more often.
 *
