...
public class SimpleCrossRef extends Unchangeable implements CrossRef {
  ...
  /**
   * Creates a new instance of SimpleCrossRef with the values to use for the immutable database
  ...
  /**
   * Creates a new instance of SimpleCrossRef with the values to use for the immutable database
   * name, accession and version. Identical to other dbname/accession/version constructor except the
   * version is specified as an Integer object rather than an int primitive. Will throw an exception
   * if version is null.
   * 
   * @param dbname the dbname for this crossref.
   * @param accession the accession for this crossref.
  ...
  /**
   * {@inheritDoc} Compares cross references first by database name, then by accession, then by
   * version.
   */
  ...
  /**
   * {@inheritDoc} Equality is defined as having the same database name, accession and version.
   */
  public boolean equals(Object obj) {
    ...
    return (this.dbname.equals(them.getDbname()) && this.accession.equals(them.getAccession())
  ...
  /**
   * {@inheritDoc} Form: "dbname:accession.version"
   */
