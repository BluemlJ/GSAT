...
/**
 * The namespace of an entry in a database schema. Relates directly to the BioDatabase table in
 * BioSQL. All BioEntry objects belong to namespaces.
 * 
...
public interface Namespace extends Comparable, Changeable {
  ...
  public static final ChangeType NAME =
      new ChangeType("This namespace's name has changed", "org.biojavax.Namespace", "NAME");
  public static final ChangeType AUTHORITY = new ChangeType(
      "This namespace's authority has changed", "org.biojavax.Namespace", "AUTHORITY");
  public static final ChangeType DESCRIPTION = new ChangeType(
      "This namespace's description has changed", "org.biojavax.Namespace", "DESCRIPTION");
  public static final ChangeType ACRONYM =
      new ChangeType("This namespace's acronym has changed", "org.biojavax.Namespace", "ACRONYM");
  public static final ChangeType URI =
      new ChangeType("This namespace's URI has changed", "org.biojavax.Namespace", "URI");

  /**
   * The name of the namespace is immutable and must be set by the constructor of the instantiating
   * class. The name should also be unique. This method will return the name.
   * 
  ...
  /**
   * Sets an optional acronym for the namespace. Null will unset it. Note that in BioSQL 1.0 Acronym
   * is only part of the Oracle schema therefore it will only be persisted in that schema.
   * 
  ...
  /**
   * Sets an optional URI for the namespace. Null will unset it. Note that in BioSQL 1.0 URI is not
   * persisted into the database unless the extended Oracle schema is used.
   * 
