...
public abstract class NestedKernel implements SVMKernel, Serializable {
  ...
  /**
   * Create a new <span class="type">NestedKernel</span> that wraps <span class="arg">k</span>.
   *
  ...
  /**
   * Set the <span class="type">SVMKernel</span> to nest to <span class="arg">k</span>.
   *
