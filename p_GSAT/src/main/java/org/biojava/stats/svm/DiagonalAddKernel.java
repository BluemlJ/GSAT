...
public class DiagonalAddKernel extends NestedKernel {
   ...
   * <p>
   * This is equal to <code>k(a, b) + d(a, b) * ||class(a)|| / (||class||)</code> where d(a, b) is
   * zero if a != b, and 1 if a == b. class(a) is the set of all items in the same class as a. class
   * is all items with a classification.
   */
  ...
  public String toString() {
    return "DiagonalAdd K(a, b | l, s+, s-, k) = k(a, b) + d[a, b]; d[a, b] = "
