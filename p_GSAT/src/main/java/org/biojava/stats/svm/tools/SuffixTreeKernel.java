...
/**
 * Computes the dot-product of two suffix-trees as the sum of the products of the counts of all
...
public class SuffixTreeKernel implements SVMKernel, Serializable {
  /**
   * The <span class="type">DepthScaler</span> that will scale each sub-space. This defaults to
   * <span class="type">UniformScaler</type>.
   */
  ...
  /**
   * Calculate the dot product between the <span class="type">SuffixTree</span>s
   * <span class="arg">a</span> and <span class="arg">b</span>.
   * <p>
   * This is the sum of the dot products of each subspace for a given word length. Each subspace is
   * scaled using the <span class="type">DepthScaler</span> returned by
   ...
   * @throws <span class="type">ClassCastException</span> if either <span class="arg">a</span> or
   *         <span class="arg">b</span> are not castable to <span class="type">SuffixTree</span>
   */
   ...
   * <span class="type">SuffixTree.SuffixNode</span>s <span class="arg">n1</span> and
   * <span class="arg">n2</span>.
   * <p>
   * This scales <span class="arg">n1</span>. <span class="method">getNumber</span><code>()</code> *
   * <span class="arg">n2</span>. <span class="method">getNumber</span><code>()</code> by
   * <span class="const">this</span>.<span class="method">getDepthScaler</span>
   * (<span class="arg">depth</span>), and then returns the sum of this and the dot products for all
   * children of the suffix nodes.
   */
  private double dot(SuffixTree st1, SuffixTree.SuffixNode n1, SuffixTree st2,
  ...
  public static class SelectionScalar implements DepthScaler, Serializable {
    ...
    /**
     * Make a new <span class="type">SelectionScalar</span> that masks in different depths.
     *
    ...
    /**
     * @return 1.0 or 0.0 depending on whether the bit at <span class="arg">depth</span> is set or
     *         not
     */
    public double getScale(int depth) {
      if (bSet.get(depth)) {
