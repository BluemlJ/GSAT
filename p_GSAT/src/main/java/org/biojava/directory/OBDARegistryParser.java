...
public class OBDARegistryParser {
  ...
  /**
   * <code>parseRegistry</code> parses an Open Bioinformatics Database Access (OBDA) configuration
   * file.
   *
   * @param in a <code>BufferedReader</code>.
   * @param locator a <code>String</code> a configuration file locator.
   *
   * @return a <code>RegistryConfiguration</code>.
   *
   * @exception IOException if an error reading the configuration file.
   * @exception RegistryException if the configuration setup fails.
   */
  public static RegistryConfiguration parseRegistry(BufferedReader in, String locator)
