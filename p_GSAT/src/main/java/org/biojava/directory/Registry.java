...
/**
 * <p>
 * <code>Registry</code> is a factory which gets implementations of the BioJava
 * <code>SequenceDBLite</code> interface. This is the point of entry for OBDA access.
 * </p>
 *
 * @author Brian Gilman
 * @author Thomas Down
...
public class Registry {
  ...
  /**
   * Creates a new OBDA <code>Registry</code> with the specified configuration.
   *
  ...
  /**
   * <code>getDatabase</code> retrieves a database instance known by a name <code>String</code>.
   *
   * @param dbName a <code>String</code> database name.
   *
   * @return a <code>SequenceDBLite</code>.
   *
   * @exception RegistryException if the registry does not contain a configuration for the specified
   *            name.
  ...
  public SequenceDBLite getDatabase(String dbName) throws RegistryException, BioException {
    ...
    List dbConfigs = (List) getRegistryConfiguration().getConfiguration().get(dbName);
      ...
      while (implNames.hasNext()) {
        ...
        try {
          ...
          throw new RegistryException(
              "Could not find class: " + className + " for service provider " + providerName, ce);
        }
      }
  ...
  /**
   * <code>getRegistryConfiguration</code> returns the configuration of the registry.
   *
