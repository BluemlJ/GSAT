 ...
 * <ol>
 * <li>~/.bioinformatics/seqdatabase.ini where ~ is the JAVA user home system property</li>
 ...
 * <code>OBDA_SEARCH_PATH</code> system environment variable. This environment variable is a "+"
 * delimted string of files and URLs. The search order proceeds from read left to right.
 * </p>
 *
 * @author Thomas Down
