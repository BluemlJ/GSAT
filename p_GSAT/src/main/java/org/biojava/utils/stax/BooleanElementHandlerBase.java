 ...
 *
 * Copyright for this code is held jobooleanly by the individual authors. These should be listed
 ...
 * setBooleanValue method. Typical use of this class is as a base for a small (often anonymous)
 * class which takes the boolean value and stores it in some variable.
 * </p>
 *
