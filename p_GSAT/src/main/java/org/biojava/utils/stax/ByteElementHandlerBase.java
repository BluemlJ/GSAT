 ...
 *
 * Copyright for this code is held jobytely by the individual authors. These should be listed
 ...
 * setByteValue method. Typical use of this class is as a base for a small (often anonymous) class
 * which takes the byte value and stores it in some variable.
 * </p>
 *
