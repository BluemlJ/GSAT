...
/**
 * StAX handler for any element which just contains a string. This class collects the string data,
 * and when it is complete, passes it to the (abstract) setStringValue method. Typical use of this
 * class is as a base for a small (often anonymous) class which takes the string value and stores it
 * in some variable.
 *
 * @author Thomas Down
 * @author Greg Cox
...
public abstract class StringElementHandlerBase extends StAXContentHandlerBase {
  ...
  /**
   * Override this method to do something useful with the string we collect. Maybe we should do this
   * by delegation rather than extension.
   */
