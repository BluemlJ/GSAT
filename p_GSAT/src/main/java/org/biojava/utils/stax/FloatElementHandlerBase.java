 ...
 *
 * Copyright for this code is held jofloatly by the individual authors. These should be listed
 ...
 * <p>
 * This class collects the string data, and when it is complete, passes it to the (abstract)
 * setFloatValue method. Typical use of this class is as a base for a small (often anonymous) class
 * which takes the float value and stores it in some variable.
 *
