 ...
 *
 * Copyright for this code is held jodoublely by the individual authors. These should be listed
 ...
 * setDoubleValue method. Typical use of this class is as a base for a small (often anonymous) class
 * which takes the double value and stores it in some variable.
 * </p>
 *
