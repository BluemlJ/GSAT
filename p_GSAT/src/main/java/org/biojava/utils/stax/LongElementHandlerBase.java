 ...
 *
 * Copyright for this code is held jolongly by the individual authors. These should be listed
 ...
 * setLongValue method. Typical use of this class is as a base for a small (often anonymous) class
 * which takes the long value and stores it in some variable.
 *
