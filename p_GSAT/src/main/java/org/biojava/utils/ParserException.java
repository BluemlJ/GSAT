...
/**
 * Exception thrown when an error occurs in document parsing. It may optionally include the
 * following fields:
 *
 * <pre>
...
public class ParserException extends Exception {
   ...
   *
   * @return A locator string, or <code>null</code> if none is known.
   */
   ...
   *
   * @return The first character in the line where the parser detected an error, or -1 if the
   *         exception effects the whole line.
   */
  ...
  /**
   * Represent this exception as a string. This includes the default exception toString
   * representation, followed by details of the location where the error occured, if they were
   * supplied when constructing this exception.
   *
