...
/**
 * solves y = f(x) = 0 by binary search. Only really suitable for monotonic functions as the method
 * will check that the initial values lie on opposite sides of the X=0 axis.
 *
 * @author David Huen
 */
