...
/**
 * 
 * Exception which is thrown when a ChangeListener does not wish a change to take place. Since
 * BioJava 1.5 the <code>ChangeVetoException</code> has been changed to extend
 * <code>RuntimeException</code>. It is therefore an unchecked exception.
 *
 * @author Thomas Down
