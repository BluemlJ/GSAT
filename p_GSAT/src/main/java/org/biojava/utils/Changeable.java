...
/**
 * This is a flag interface that defines the common add/remove listener methods for classes and
 * interfaces that wish to indicate that they are sources of ChangeEvents.
 *
...
public interface Changeable {
   ...
   *
   * <p>
   * If this returns true, then it is guaranteed that change events of this type (and all child
   * types) can never under any circumstances be fired by this Changeable instance. If it returns
   * false, that does not mean that this type of event will or even can be raised, but that it is
   * worth registering listeners incase.
   * </p>
   *
