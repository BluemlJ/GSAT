...
public class Pattern {
  ...
  /**
   * returns the actual String used to construct the regex with all ambiguities expanded. //FIXME:
   * do something about unicode strings and conversion back to something sensible.
   */
