...
public class Search {
   ...
   * @param overlap if true, the search continues at the base following the start to the previous
   *        hit. If false, it continues at the base after the existing hit.
