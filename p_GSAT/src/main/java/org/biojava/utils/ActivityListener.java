...
/**
 * Interface for object which monitor long-running activities. (may be subject to change before
 * 1.2-final)
 *
 * @author Thomas Down
 * @since 1.2
...
public interface ActivityListener {
  ...
  /**
   * Estimated progress of an activity. This indicated that <code>current</code> parts of the
   * activity have been completed, out of a target <code>target</code>.
   */
