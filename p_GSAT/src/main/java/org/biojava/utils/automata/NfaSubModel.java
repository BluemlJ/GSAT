...
/**
 * This class caches a reference to all objects that it directs its delegate to make. These
 * references make it relatively easy for it to duplicate all objects made through this class.
 */
public class NfaSubModel implements NfaBuilder {
  ...
  public FiniteAutomaton.Transition addTransition(FiniteAutomaton.Node start,
      FiniteAutomaton.Node end, Symbol sym) {
    FiniteAutomaton.Transition newTransition = delegate.addTransition(start, end, sym);
    transitions.add(newTransition);
    return newTransition;
  }

  public FiniteAutomaton.Transition addEpsilonTransition(FiniteAutomaton.Node start,
      FiniteAutomaton.Node end) {
    FiniteAutomaton.Transition newTransition = delegate.addEpsilonTransition(start, end);
    transitions.add(newTransition);
    return newTransition;
  }

  public FiniteAutomaton.Transition addLambdaTransition(FiniteAutomaton.Node start,
      FiniteAutomaton.Node end) {
