...
public abstract class AbstractChangeable implements Changeable {
  ...
  /**
   * Called the first time a ChangeSupport object is needed. Override this if you want to set the
   * Unchanging set on the ChangeSupport, or if you want to install listeners on other objects when
   * the change system is initialized.
   *
   * @since 1.3
   */
   ...
   * </pre></code>
   *
   * It is usual for the forwarding listeners (someForwarder in this example) to be transient and
   * lazily instantiated. Be sure to register & unregister the forwarder in the code that does the
   * ChangeEvent handling in setter methods.
   */
