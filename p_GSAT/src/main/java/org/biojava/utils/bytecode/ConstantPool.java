...
public class ConstantPool {
  ...
  public int resolveField(CodeField f) {
    try {
      return resolve(new CPRefEntry(CONSTANT_Fieldref, resolveClass(f.getContainingClass()),
          resolveNameAndType(f.getName(), f.getType().getDescriptor())));
  ...
  public int resolveMethod(CodeMethod m) {
    return resolve(new CPRefEntry(CONSTANT_Methodref, resolveClass(m.getContainingClass()),
        resolveNameAndType(m.getName(), m.getDescriptor())));
  }

  public int resolveInterfaceMethod(CodeMethod m) {
    return resolve(new CPRefEntry(CONSTANT_InterfaceMethodref, resolveClass(m.getContainingClass()),
        resolveNameAndType(m.getName(), m.getDescriptor())));
  }
  ...
  private int resolve(CPEntry e) {
    for (int i = 1; i < constants.size(); ++i) {
      ...
      if (e2 != null && e.equals(e2)) return i;
    }
  ...
  private static class CPTypedStringEntry implements CPEntry {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof CPTypedStringEntry)) return false;
  ...
  private static class CPRefEntry implements CPEntry {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof CPRefEntry)) return false;
  ...
  private static class CPIntEntry implements CPEntry {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof CPIntEntry)) return false;
  ...
  private static class CPLongEntry implements CPEntry {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof CPLongEntry)) return false;
  ...
  private static class CPFloatEntry implements CPEntry {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof CPFloatEntry)) return false;

      return (((CPFloatEntry) o).val == val)
  ...
  private static class CPDoubleEntry implements CPEntry {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof CPDoubleEntry)) return false;

      return (((CPDoubleEntry) o).val == val)
  ...
  private static class CPUtf8Entry implements CPEntry {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof CPUtf8Entry)) return false;
  ...
  private static class CPNameAndTypeEntry implements CPEntry {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof CPNameAndTypeEntry)) return false;
