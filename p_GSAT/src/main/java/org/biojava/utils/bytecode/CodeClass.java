...
/**
 * Interface for Java classes within the bytecode generation framework. Any class (or interface) can
 * be viewed as a CodeClass, whether it is pre-existing or being generated.
 *
 * @author Thomas Down
...
public interface CodeClass {
  ...
  /**
   * Get all methods declared by this class and its super classes, removing all super class methods
   * that are over ridden.
   *
   * <p>
   ...
   * @throws NoSuchFieldException if there is no field by that name accessible through this class
   */
