...
/**
 * Simple {@linkplain org.biojava.utils.process.OutputHandler output handler} that pipes the output
 * of an external process to an {@linkplain org.biojava.utils.process.StreamPipe#getOutput() output
 * stream}.
 * 
...
public class SimpleOutputHandler extends StreamPipe implements OutputHandler {
   ...
   * 
   * @param output the output stream to which to write the output of the external process. May be
   *        <code>null</code>.
