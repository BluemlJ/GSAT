...
/**
 * Simple {@linkplain org.biojava.utils.process.OutputHandler output handler} that writes the output
 * of an external process to an {@linkplain org.biojava.utils.process.ReaderWriterPipe#getWriter()
 * writer}.
 * 
...
public class WriterOutputHandler extends ReaderWriterPipe implements OutputHandler {
   ...
   * 
   * @param writer the writer to which to write the output of the external process. May be
   *        <code>null</code>.
