...
public class StreamPipe implements Runnable {
   ...
   * 
   * @param input the input stream from which to read. May be <code>null</code>.
   * @param output the output stream to which to write May be <code>null</code>.
   * @param tag a tag which is used for logging the in- and output May be <code>null</code>.
   */
