...
/**
 * Interface to a {@linkplain java.lang.Runnable threadable} input handler for an
 * {@linkplain org.biojava.utils.process.ExternalProcess external process}. The input handler is
 * used to write the {@linkplain java.lang.Process#getInputStream() STDIN} input of an external
 * process.
 * 
