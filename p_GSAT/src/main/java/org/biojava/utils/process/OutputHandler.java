...
/**
 * Interface to a {@linkplain java.lang.Runnable threadable} output handler for an
 * {@linkplain org.biojava.utils.process.ExternalProcess external process}. The output handler is
 * used to collect the output of the {@linkplain java.lang.Process#getOutputStream()() STDOUT}
 * output and/or the {@linkplain java.lang.Process#getErrorStream() STDERR} of an external process.
 * 
