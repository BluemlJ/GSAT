...
/**
 * <code>RandomAccessReader</code> extends <code>Reader</code> to provide a means to create buffered
 * <code>Reader</code>s from <code>RandomAccessFile</code>s.
 *
 * @author Keith James
 * @since 1.2
 */
public class RandomAccessReader extends Reader {
  ...
  /**
   * Creates a new <code>RandomAccessReader</code> wrapping the <code>RandomAccessFile</code> and
   * using a default-sized buffer (8192 bytes).
   *
  ...
  /**
   * <code>length</code> returns the length of the underlying <code>RandomAccessFile</code>.
   *
  ...
  /**
   * <code>read</code> reads one byte from the underlying <code>RandomAccessFile</code>.
   *
   * @return an <code>int</code>, -1 if the end of the stream has been reached.
   *
   * @exception IOException if an error occurs.
   */
  public final int read() throws IOException {
    ...
    if (bufferPos >= bufferEnd) if (fill() < 0) return -1;
  ...
  /**
   * <code>read</code> reads from the underlying <code>RandomAccessFile</code> into an array.
   *
   * @param cbuf a <code>char []</code> array to read into.
   * @param off an <code>int</code> offset in the array at which to start storing chars.
   * @param len an <code>int</code> maximum number of char to read.
   *
   * @return an <code>int</code> number of chars read, or -1 if the end of the stream has been
   *         reached.
   *
   * @exception IOException if an error occurs.
   */
  ...
  /**
   * <code>getFilePointer</code> returns the effective position of the pointer in the underlying
  ...
  private int fill() throws IOException {
    if (raf == null) throw new IOException("Random access file closed");
  ...
  /**
   * <code>resetBuffer</code> resets the buffer when the pointer leaves its boundaries.
   *
   * @exception IOException if an error occurs.
   */
