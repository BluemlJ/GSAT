...
/**
 * Lightweight implementation of Map which uses little memory to store a small number of mappings,
 * at the expense of scalability. Not recommended for more than 20-30 mappings.
 *
 * <p>
 * This implementation has the useful property that the iteration order is the same as the order in
 * which mappings are added.
 * </p>
 *
 * @author Thomas Down
 * @author Len Trigg
