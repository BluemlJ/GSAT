...
public class ResourceEntityResolver implements EntityResolver {
  ...
  /**
   * Construct a resolver which searches for resources in the specified path relative to the current
   * classloader.
   */
  ...
  /**
   * Construct a resolver which searches for resources in the specified list of directories relative
  ...
  /**
   * Construct a resolver which searches for resources in the specified path relative to the
