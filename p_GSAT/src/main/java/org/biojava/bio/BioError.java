 ...
 *
 * 
 * Catch this whenever it, or one of it's sub-classes are thrown and you know what to do once you've
 * got it. Note: in general, you should not be catching errors. However, there are cases where it is
 * necisary e.g. for logging. You will nearly always want to either re-throw the Error, throw a new
 * Error or exit the current thread.
 *
 * 
