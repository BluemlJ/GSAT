...
public interface TransitionTrainer {
   ...
   * <p>
   * This method may be called multiple times with the same from,to pair in which case, the times
   * should be summed.
   *
   ...
   * <p>
   * This is equivalent to adding a count of nullModel * weight to each transition and then training
   * with a weight of 0.
   *
