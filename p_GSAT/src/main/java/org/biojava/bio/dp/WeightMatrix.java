 ...
 * <p>
 * The weight matrix uses computer-coordinates. Thus, a 10 column weight matrix has columns (0 - 9).
 * I guess that if you try to access columns outside the logical range, the implementation may throw
...
public interface WeightMatrix {
   ...
   * @throws IndexOutOfBoundsException if column is not between 0 and columns()-1
