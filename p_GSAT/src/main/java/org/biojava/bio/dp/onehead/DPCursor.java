...
/**
 * Encapsulates the dynamic programmming matrix, and the context within algorithms work. The cursor
 * should put DP.MAGICAL_SYMBOL symbols at either end of the sequence.
 *
