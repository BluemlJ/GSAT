...
public interface ScoreType {
   ...
   */
  double calculateScore(Distribution dist, Symbol sym) throws IllegalSymbolException;
  ...
  /**
   * In this class, calculateScore returns the odds ratio of a symbol being emitted. That is, the
   * ratio of the probability of a Symbol being emitted to it being emitted by the null model.
   *
   * @author Matthew Pocock
   */
  ...
  /**
   * In this class, calculateScore returns the probability of a Symbol being emitted by the null
   * model.
   *
   * @author Matthew Pocock
   */
