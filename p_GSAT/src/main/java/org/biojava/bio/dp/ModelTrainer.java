...
public interface ModelTrainer extends DistributionTrainerContext {
   ...
   * <p>
   * If the model has been already registered, then this method should do nothing. If it has not
   * been registered, then this method should loop over every state in the model and register the
   * Distribution returned by getWeight.
   *
