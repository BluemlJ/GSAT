 ...
 * <p>
 * Dot states emit no sequence. They are there purely to make the wireing of the model look neater,
 * and to cut down the number of combinatorial transitions that can so easily swamp models.
 *
...
public class SimpleDotState extends FundamentalAtomicSymbol implements DotState, Serializable {
  /**
   * Construct a new state with the specified name and annotation. The token parameter is ignored
