...
public interface StoppingCriteria {
   ...
   *
   * This can be on the basis of the scores published by ta. Or, it could be set to expire at a
   * given cycle, or due to user intervention. It is perfectly acceptable for this method to have
