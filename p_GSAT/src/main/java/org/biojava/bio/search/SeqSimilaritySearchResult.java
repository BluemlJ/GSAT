...
public interface SeqSimilaritySearchResult extends Annotatable {
   ...
   *
   * @return the <code>Sequence</code> object used to search the <code>SequenceDB</code>. Never
   *         returns null.
   */
   ...
   *
   * @return the <code>SequenceDB object</code> against which the search was carried out. Never
   *         returns null.
   */
  ...
  /**
   * Return all hits in this sequence similarity search result. The hits are sorted from best to
   * worst.
   *
   * @return an (immutable) <code>List</code> of <code>SeqSimilaritySearchHit</code> objects
   *         containing all hits in the search result. Never returns null but may return an empty
   *         list.
   */
  public List getHits();
}
