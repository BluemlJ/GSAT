...
/**
 * This class prints to a PrintStream calls to the SearchContentHandler interface in human readable
 * form. Use to debug parser/adaptor classes that output to the SearchContentHandler interface.
 * 
 * @author David Huen
 */
