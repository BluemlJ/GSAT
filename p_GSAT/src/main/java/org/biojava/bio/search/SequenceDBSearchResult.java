...
/**
 * <code>SequenceDBSearchResult</code> objects represent a result of a search of a
 ...
 * @since 1.1
 * @deprecated SimpleSeqSimilaritySearchResult has been made Annotatable and is now functionally
 *             identical.
...
public class SequenceDBSearchResult extends AbstractChangeable
   ...
   */
  public SequenceDBSearchResult(Sequence querySequence, SequenceDB sequenceDB, Map searchParameters,
      List hits, Annotation annotation) {
  ...
  public String toString() {
    return "SequenceDBSearchResult of " + getQuerySequence() + " against "
