...
/**
 * <p>
 * Filtering implementation of SearchContentHandler that by default passes all messages on to the
 * next delegate in the chain.
 * </p>
 *
 * <p>
 * In this handler, all info will be passed onto a delegate handler. You can build up a chain of
 * filters by using one filter as the delegate for another. When you over-ride a method in a filter,
 * you can modify any state you wish. If you want that to propogate on, you should call the method
 * on yourself via super.(), if not, just return.
 * </p>
 *
 * <p>
 * It is your responsibility to ensure that the events emitted from your filter are sensible. In
 * particular, start/end messages must be paired even after filtering.
 * </p>
 *
 * <h2>Example</h2>
 *
