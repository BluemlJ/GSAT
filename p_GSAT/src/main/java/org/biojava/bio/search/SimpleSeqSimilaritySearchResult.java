...
/**
 * <code>SimpleSeqSimilaritySearchResult</code> objects represent a result of a search of a
 * <code>SymbolList</code> against the sequences within a <code>SequenceDB</code> object. The core
 * data (query sequence, database, search parameters, hits) have accessors, while supplementary data
 * are stored in the <code>Annotation</code> object. Supplementary data are typically the more
 * loosely formatted details which vary from one search program to another (and between versions of
 * those programs).
 *
 * @author Keith James
...
public class SimpleSeqSimilaritySearchResult extends AbstractChangeable
   ...
   */
  public SimpleSeqSimilaritySearchResult(Sequence querySequence, SequenceDB sequenceDB,
      Map searchParameters, List hits, Annotation annotation) {
  ...
  public boolean equals(Object other) {
    ...
    SimpleSeqSimilaritySearchResult that = (SimpleSeqSimilaritySearchResult) other;
  ...
  public String toString() {
    return "SimpleSeqSimilaritySearchResult of " + getQuerySequence() + " against "
