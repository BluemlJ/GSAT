...
/**
 * Class for implementing tests with BlastLikeSearchFilter objects. Several precanned tests are
 * included.
 * 
 * @author David Huen
 */
public interface FilterTest {
  ...
  /**
   * Tests that the value associated with the specified key is equal to the value supplied here by
   * whatever criterion of equality appropriate to those objects. A value of false is returned by
   * accept() if a ClassCastException is thrown on comparing the objects.
   */
  ...
  /**
   * Tests that the value associated with the specified key is matched in its entirety by the
   * supplied regex. A value of false is returned by accept() if a ClassCastException is thrown on
  ...
  /**
   * Tests that the value associated with the specified key contains a part matched by the supplied
   * regex. A value of false is returned by accept() if a ClassCastException is thrown on comparing
   * the objects.
   */
   ...
   * The test assumes that value is a String representing a real number. If not, the test will
   * return null.
   */
