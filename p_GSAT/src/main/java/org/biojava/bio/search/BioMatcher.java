...
public interface BioMatcher {
   ...
   *
   * <p>
   * If the pattern can be found, then this will return true. If it could not, then it will return
   * false. This is convenient within for or while loops.
   * </p>
   *
   * <p>
   * Each time this is called, the next match will be found. The start() and end() values will
   * increase each time, regardless of wether you called any other methods.
   * </p>
   *
