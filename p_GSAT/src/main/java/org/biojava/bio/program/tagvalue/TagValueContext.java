...
/**
 * Communication interface between Parser and a TagValueListener that allows listeners to request
 * that a parser/listener pair be pushed onto the stack to handle the current tag.
 *
