...
public class HitMerger implements SearchListener {
   ...
   *
   * @param delegate the SearchListener to inform of all merged and filtered hits
  ...
  public void endSearch(String seqID) {
    ...
    OUTER: for (int i = 0; i < hitList.size(); i++) {
  ...
  private static class Hit implements Comparable {
    public int hitID;
    ...
    public boolean equals(Object o) {
      if (o instanceof Hit) {
        Hit r = (Hit) o;
        return hitID == r.hitID && queryOffset == r.queryOffset && hitOffset == r.hitOffset
