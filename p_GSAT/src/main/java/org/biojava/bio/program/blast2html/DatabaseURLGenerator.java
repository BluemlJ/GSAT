...
/**
 * Takes a database ID and some configuration properties ( such as base URL ) and returns either a
 * URL or a full anchor tag.
 *
 *
...
public interface DatabaseURLGenerator {
  ...
  /**
   * Returns a full <a href=_____>retrieve item</a> anchor for the given database id. Used in detail
   * section.
   *
