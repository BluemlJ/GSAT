...
public class TagDropper extends SimpleTagValueWrapper {
  ...
  /**
   * Create a new TagDropper that will pass on all retained tags and values to tvl. Initially, no
   ...
   *
   * <p>
   * If retain is true, then all known tags will be passed on and all other tags will be discarded.
   * If retain is true, then all known tags will be dropped and all others passed on.
   * </p>
   *
