 ...
 *
 * <p>
 * Implementations will tend to intercept the tags or values as they stream through and modify them
 * in some manner before forwarding them to the delegate listener. Using classes derived from
 * SimpleTagValueWrapper, it is possible to build up complex chains of handlers that process and
 * collate information as it streams through.
 * </p>
 *
