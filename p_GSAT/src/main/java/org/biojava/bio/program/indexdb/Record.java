...
/**
 * <code>Record</code> represents a record within an indexed flat file databank as defined by the
 * OBDA standard.
 *
...
public interface Record {
  ...
  /**
   * <code>getID</code> returns the primary identifier of the record.
   *
  ...
  /**
   * <code>getFile</code> returns the random access file in which the record belongs.
   *
  ...
  /**
   * <code>getOffset</code> returns the byte offset in the file at which the record begins.
   *
  ...
  /**
   * <code>getLength</code> returns the length of the record in bytes.
   *
