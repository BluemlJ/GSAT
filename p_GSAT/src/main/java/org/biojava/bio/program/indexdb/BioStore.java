...
/**
 * <code>BioStore</code>s represent directory and file structures which index flat files according
 * to the OBDA specification. The preferred method of constructing new instances is to use
...
public class BioStore implements IndexStore {
  ...
  /**
   * <code>STRING_CASE_SENSITIVE_ORDER</code> compares two <code>Object</code>s, which must both be
   * <code>String</code>s, lexicographically using <code>compareTo</code>. The comparison is carried
   * out 'a' to 'b'.
   */
  ...
  /**
   * Creates a new <code>BioStore</code> flatfile index at the specified location with the specified
   * caching behaviour.
   *
   * @param location a <code>File</code> indicating the index directory.
   * @param cache a <code>boolean</code> indicating whether the implementation should cache its
   *        state.
   *
  ...
  /**
   * <code>getLocation</code> returns the directory where the index is located.
   *
  ...
  /**
   * <code>getRecordList</code> returns all the <code>Record</code>s in the index.
   *
