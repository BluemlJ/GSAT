...
public class FormatTools {
  ...
  public static final ChangeTable.Changer EC_FROM_STRING = new ChangeTable.Changer() {
   ...
   * <ol>
   * <li>Treat the name as an LSID and search for a format class with that LSID.</li>
   * <li>Load a class of that name</li>
   * <li>Load a class in the package <code>org.biojava.bio.program.formats</code> with that
   * name</li>
   * <li>Load a class in that package after replacing each '.' in the name with "$" so that a search
   * is made of inner classes.</li>
   * </ol>
   * <p>
   *
   * <p>
   ...
   * </p>
   *
   * This method uses the service providor framework to find format providers. If you add formats to
   * the core biojava distribution, you must add the class name to the file
   * <code>biojava-live/resources/META-INF/services/org.biojava.bio.program.formats.Format</code>/
   * If you implement formats and place them in your own .jar files, you should put the class name
   * in a similarly named file in your jar. This should mean that the format becomes automatically
  ...
  public static Format getFormat(String formatName) throws BioException {
    ...
    if (format == null) {
      ...
      if (formatClass == null) {
        String fn = "org.biojava.bio.program.formats." + formatName;
        try {
      ...
      if (formatClass == null) {
        String fn = "org.biojava.bio.program.formats." + formatName.replace('.', '$');
        try {
          formatClass = ClassTools.getClassLoader(Parser.class).loadClass(fn);
        } catch (ClassNotFoundException cnfe2) {}
      }
  ...
  private static Map getLsid2Format() throws BioException {
    if (LSID_2_FORMAT == null) {
      try {
        ...
        Iterator implNames = Services.getImplementationNames(Format.class, loader).iterator();
