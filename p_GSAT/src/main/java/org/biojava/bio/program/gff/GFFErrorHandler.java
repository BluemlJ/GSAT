...
/**
 * Interface which captures any errors which occur when parsing a GFF stream. Providing a custom
 * implementation of this interface allows intelligent recovery from errors when parsing GFF.
 *
 * <p>
 * Each of these methods has three options:
 *
 * <ul>
 * <li>Throw a ParserException. This need only contain a detail message, the parser will fill in
 * other fields. parsing will be aborted.</li>
 * <li>Throw an IgnoreRecordException. This line of the GFF file will be ignored, but parsing will
 * not be aborted</li>
...
public interface GFFErrorHandler {
  ...
  public int invalidStart(String token) throws ParserException, IgnoreRecordException;
  ...
  public int invalidEnd(String token) throws ParserException, IgnoreRecordException;
  ...
  public double invalidScore(String token) throws ParserException, IgnoreRecordException;
  ...
  public int invalidFrame(String token) throws ParserException, IgnoreRecordException;
