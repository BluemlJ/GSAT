...
/**
 * <p>
 * Abstract implementation of <code>AlignmentStyler</code>, contains utility methods for generating
 * a set of HTML styles from a list of RGB colours.
 * </p>
 *
 * <p>
 * Thus <code>getAlignmentStyles()</code> is implemented and all that remains to be implemented is
 * the <code>getStyle</code> method.
 *
 * <pre>
 * Primary author -
 *                 Colin Hardman      (CAT)
...
public abstract class AbstractAlignmentStyler implements AlignmentStyler {
   ...
   * @param poColour the color in hex eg 'FFA2A2' for a nice red ( R = FF, G = A2 and B = A2 )
   */
  public void addStyle(String poChar, String poColour) {

    String oColourClass = this.getColourClass(poColour);
  ...
  /**
   * <p>
   * Returns the colour class for the specified colour (in hex). If one is not already defined for
   * that colour then a new class is created and returned.
   * </p>
   *
   * <p>
