...
/**
 * <p>
 * Interface for specifying both the overall set of possible markup styles and the particular style
 * for any pair of residues/bases.
 * </p>
 *
 * <p>
 * This can be independent of the choice of whether to apply a style to a pair, by using the
 * <code>ColourCommand</code> interface.
 * </p>
 *
 * <p>
 * <pre>
...
interface AlignmentStyler {
  ...
  /**
   * <p>
   * Modifies in place the styles for the two aligned characters and the consensus ( in the form of
   * predefined font classes ).
   * </p>
   *
   * <p>
   ...
   * @param poStyleHolder - an array to hold the styles, [0] = first, [1] = second, [2] = markup
   * 
   */
