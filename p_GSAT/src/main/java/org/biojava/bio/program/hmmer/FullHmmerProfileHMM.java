...
/**
 * This is a class for representing the full HMMER generated Profile HMM (including loop states N
 * and C terminal looping states).
 *
 * @author Lachlan Coin
 * @since 1.3
 */
public class FullHmmerProfileHMM extends SimpleMarkovModel {
  ...
  FullHmmerProfileHMM(HmmerProfileHMM hmm) throws IllegalSymbolException,
      IllegalTransitionException, IllegalAlphabetException, ChangeVetoException {
