...
/**
 * <code>SearchableFileAsList</code> is an abstract base class which implements binary ID searching
 * over the backing random access file.
 *
...
abstract class SearchableFileAsList extends FileAsList implements SearchableList {
  /**
   * Creates a new <code>SearchableFileAsList</code> and corresponding backing file.
   *
   * @param file a <code>File</code> used to back the list. This file must not already exist.
  ...
  /**
   * Creates a new <code>SearchableFileAsList</code> instance from an existing backing file.
   *
   * @param file a <code>File</code> used to back the list. This file must already exist.
