...
public interface DataStore {
   ...
   *
   * @throws IllegalAlphabetException if the symbol list is of a type that is not compatible with
   *         this data store
   */
   ...
   */
  public String seqNameForID(int id) throws IndexOutOfBoundsException, SearchException;
}
