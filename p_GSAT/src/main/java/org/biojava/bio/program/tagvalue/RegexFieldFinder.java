...
public class RegexFieldFinder extends SimpleTagValueWrapper {
   ...
   * @param tags an array of Strings giving tag names for each group in the pattern
   * @param inLine if false, an entire sub-document will be generated for the parent tag
   */
  public RegexFieldFinder(TagValueListener delegate, Pattern pattern, String[] tags,
      boolean inLine) {
    super(delegate);
