...
/**
 * <code>BioStoreFactory</code> creates <code>BioStore</code> instances. These are directory and
 * file structures which index flat files according to the OBDA specification.
 *
...
public class BioStoreFactory {
  /**
   * <code>STORE_NAME</code> is the key used to identify the arbitrary name of the store in the OBDA
   * config.dat files.
   */
  public static final String STORE_NAME = "name";

  /**
   * <code>SEQUENCE_FORMAT</code> is the key used to identify the format of the indexed sequence
   * files represented by the store in the OBDA config.dat files.
   */
  public static final String SEQUENCE_FORMAT = "format";

  /**
   * <code>PRIMARY_KEY_NAME</code> is the key used to identify the primary namespace in the OBDA
   * config.dat files.
   */
  public static final String PRIMARY_KEY_NAME = "primary_namespace";

  /**
   * <code>KEYS</code> is the key used to identify the secondary namespaces in the OBDA config.dat
   * files.
   */
  ...
  static {
    try {
      ...
      META_DATA_TYPE.setConstraints(BioStoreFactory.PRIMARY_KEY_NAME,
          new PropertyConstraint.ByClass(String.class), CardinalityConstraint.ONE);

      META_DATA_TYPE.setConstraints("index", new PropertyConstraint.ByClass(String.class),
          CardinalityConstraint.ONE);

      META_DATA_TYPE.setConstraints("format",
          new PropertyConstraint.ByClass(LifeScienceIdentifier.class), CardinalityConstraint.ONE);

      META_DATA_TYPE.setConstraints(BioStoreFactory.KEYS,
          new PropertyConstraint.ByClass(String.class), CardinalityConstraint.ONE);

      META_DATA_TYPE.setConstraints("name", new PropertyConstraint.ByClass(String.class),
  ...
  /**
   * <code>setStoreName</code> sets the name to be given to the new index.
   *
  ...
  /**
   * <code>getStoreName</code> returns the name to be given to the new index.
   *
  ...
  /**
   * <code>setStoreLocation</code> sets the directory of the new index.
   *
  ...
  /**
   * <code>getStoreLocation</code> returns the directory of the bew index.
   *
  ...
  /**
   * <code>setSequenceFormat</code> sets the sequence format name which will be indicated in the
   * index.
   *
   * @param format a <code>LifeScienceIdentifier</code> which must be one of those mandated by the
   *        OBDA flatfile indexing specification.
   */
  ...
  /**
   * <code>getSequenceFormat</code> returns the current sequence format name.
   *
  ...
  /**
   * <code>setPrimaryKey</code> sets the primary identifier namespace.
   *
  ...
  /**
   * <code>getPrimaryKey</code> returns the primary identifier namespace.
   *
   * @return a <code>String</code>.
   */
   ...
   * @param length an <code>int</code> indicating the byte length of the key records.
   */
  ...
  /**
   * <code>removeKey</code> removes the specified key.
   *
   * @param keyName a <code>String</code>.
   */
  ...
  /**
   * <code>createBioStore</code> creates a <code>BioStore</code> reflecting the current state of the
   * factory and returns a reference to it.
   *
    ...
    try {
      ...
      for (Iterator ki = keys.keySet().iterator(); ki.hasNext();) {
        ...
        if (key.equals(primaryKey)) {
          new PrimaryIDList(makePrimaryKeyFile(storeLoc, key), calculatePrimRecLen(length), null);
        } else {
  ...
  /**
   * <code>makeConfigFile</code> returns a file which represents an OBDA "config.dat" in the
   * specified index directory.
   *
   * @param storeLoc a <code>File</code> indicating the index directory.
   *
  ...
  /**
   * <code>makePrimaryKeyFile</code> returns a file which represents an OBDA "key_&lt;primary
   * namespace&gt;.key" primary key file on the specified index directory.
   *
   * @param storeLoc a <code>File</code> indicating the parent path.
   * @param key a <code>String</code> primary key namespace.
   *
   * @return a <code>File</code> representing a "key_&lt;primary namespace&gt;.key".
   *
   * @exception IOException if an error occurs.
   */
  ...
  /**
   * <code>makeSecondaryFile</code> returns a file which represents an OBDA "id_&lt;secondary
   * namespace&gt;.index" secondary key file on the specified.
   *
   * @param storeLoc a <code>File</code> indicating the parent path.
   * @param key a <code>String</code> secondary key namespace.
   *
   * @return a <code>File</code> representing an "id_&lt;secondary namespace&gt;.index" file.
   *
   * @exception IOException if an error occurs.
   */
  ...
  /**
   * <code>calculatePrimRecLen</code> calculates the byte length of primary namespace records.
   *
   * @param idLen an <code>int</code> the number of bytes required to hold the primary namespace ID.
   *
   * @return an <code>int</code> record length in bytes.
   */
  public static int calculatePrimRecLen(int idLen) {
    return idLen + // space for ids
        "\t".length() + 4 + // file id
        "\t".length() + String.valueOf(Long.MAX_VALUE).length() + // offset
        "\t".length() + String.valueOf(Integer.MAX_VALUE).length(); // length
  }

  /**
   * <code>calculateSecRecLen</code> calculates the byte length of secondary namespace records.
   *
   * @param idLen an <code>int</code> the number of bytes required to hold the secondary namespace
   *        ID.
   *
   * @param primaryKey a <code>String</code> the primary namespace ID.
   * @param keys a <code>Map</code> of secondary keys to their byte lengths.
   *
   * @return an <code>int</code> record length in bytes.
   */
