...
/**
 * A simple XML DocumentHandler that processes SAX2 events to create a sensibly formatted XML as it
 * parsed without populating objects with data. Note, need to tidy up parameter names which are poor
 * due to decompiling a .class file from an accidently deleted .java file!
 * 
 * <p>
