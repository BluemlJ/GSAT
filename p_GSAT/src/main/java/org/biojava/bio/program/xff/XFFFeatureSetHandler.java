...
/**
 * StAX handler which converts and stream of parse events for an XFF featureSet element into BioJava
 * SeqIO events.
 *
...
public class XFFFeatureSetHandler extends StAXContentHandlerBase {
  ...
  /**
   * Extend this FeatureSetHandler to delegate certain feature elements to the specified handler
   * type.
   *
  ...
  /**
   * Extend this FeatureSetHandler to delegate certain detail elements to the specified handler
   * type.
   *
  ...
  public void startElement(String nsURI, String localName, String qName, Attributes attrs,
    ...
    // System.err.println("Processing startElement(" + nsURI + ", " + localName + ", " + qName + ",
    // " + pretify(attrs));
  ...
  /**
   * Return a handler for the XFF <code>details</code> element. This handler will, in turn, delegate
   * to the specific detail handlers provided with <code>addDetailHandler</code>
   */
