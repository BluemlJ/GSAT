 ...
 * @since 1.3
 *
 *        Usefull constants for whenever you need one of the common cardinalitites. Otherwise, build
 *        a Location using the normal Location APIs.:
 */
public final class CardinalityConstraint {
  /**
   * This cardinality contains no intengers, not even zero. It means that there is no way to fulfill
   * this cardinality constraint. It's like Double.NaN
   */
  ...
  /**
   * The property should have zero or one values. This means that it is optional but if present must
