 ...
 * 
 * <p>
 * It will allow you to set any property, but will throw exceptions if you try to retrieve a
 * property that is not set. Because of the use of a <code>LinkedHashMap</code> properties are
 * iterated in the order they are entered.
 * </p>
 * When you need to make a new Annotation instance and will want to populate it with properties, use
 * this class.
 * 
...
public class SimpleAnnotation extends AbstractAnnotation {
   ...
   * 
   * @return true if any have (even if they have since been removed), false otherwise
   */
  ...
  /**
   * Create a new SimpleAnnotation by copying the properties from another one. The new Annotation
   * instance will be independant of the original.
   * 
