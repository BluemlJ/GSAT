 ...
 *
 * <p>
 * This lets the distribution implementation handle counts or distributions in the best way
 * possible.
 * </p>
 *
...
public interface DistributionTrainer {
   ...
   *
   * <p>
   * This method may be called multiple times with the same symbol. Each time it should return the
   * agregate of the counts added with addCount since the last invocation of clearCounts.
   * </p>
   *
   * @param dtc the DistributionTrainerContext within which the count was added
   * @param sym the Symbol seen
   ...
   * @throws ChangeVetoException if the distribution could not have its weights modified
   */
