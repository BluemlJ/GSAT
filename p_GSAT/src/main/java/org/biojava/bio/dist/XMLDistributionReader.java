...
/**
 * A SAX parser that reads an XML representation of a Distribution from a file and recreates it as a
 * Distribution Object. Handles OrderNDistributions and Simple Distributions but ensure the
 * OrderNDistributions being read in was made using conditioning and conditioned Alphabets.
 *
  ...
  private void processWeightElement(Attributes attr) throws SAXException {
    ...
    if ((dist instanceof OrderNDistribution) == false) {
      try {
        ...
        throw new SAXException("Couldn't get tokenization for " + dist.getAlphabet().getName(), ex);
      }
      ...
      try {
        ...
        throw new SAXException("Distribution has been locked, possible synchronization problem !?",
            ex);
      }
