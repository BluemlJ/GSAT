...
public interface DistributionTrainerContext {
  ...
  /**
   * Set the number of pseudocounts to add when training the distribution. These counts are added in
   * proportion to the null model of the distribution being trained.
   *
   ...
   *
   * <p>
   * This method is a request to the context to register dist. If dist is already registered then
   * this method should do nothing. If it is not registered, then it should invoke
   * dist.registerWithTrainer
   * </p>
   *
   ...
   *
   * <p>
   * In the registerWithTrainer method of a Distribution, it should associate itself with a trainer
   * using this method.
   * </p>
   *
   ...
   *
   * <p>
   * This method may be called multiple times with the same symbol. In this case, the times should
   * be summed.
   * </p>
   *
  ...
  /**
   * Return the number of counts of a particular symbol which will be used to train the specified
   * distribution.
   *
   * @param dist the Distribution to return counts for
   * @param sym the symbol to get the count for
   * @return the number of counts
   * @throws IllegalSymbolException if the symbol is not accepted by the distribution
   */

  double getCount(Distribution dist, Symbol sym) throws IllegalSymbolException;
   ...
   *
   * <p>
   * This will use the information collected with multiple addCount calls, and the null model to
