 ...
 * 
 * @serial WARNING serialized versions of this class may be incompatible with future versions of
 *         BioJava
...
public class UniformDistribution extends AbstractDistribution implements Serializable {
   ...
   * @throws IllegalAlphabetException if nullModel is over an incompattible alphabet
   */
  protected void setNullModelImpl(Distribution nullModel) throws IllegalAlphabetException {
    this.nullModel = nullModel;
  }

  protected double getWeightImpl(AtomicSymbol s) throws IllegalSymbolException {
