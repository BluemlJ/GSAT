...
class IndexedNthOrderDistribution extends AbstractOrderNDistribution implements Serializable {
  ...
  /**
   * Sets the Distribution attribute of the IndexedNthOrderDistribution object
   *
   * @param sym a symbol in the conditioning alphabet
   * @param dist the new Distribution
   * @exception IllegalSymbolException if the symbol is not in the conditioning alpahbet
   * @exception IllegalAlphabetException if the Distribution is not over the conditioned alphabet
   */
  public void setDistribution(Symbol sym, Distribution dist)
    ...
    if (dist.getAlphabet() != getConditionedAlphabet()) {
      throw new IllegalAlphabetException("The distribution must be over " + getConditionedAlphabet()
  ...
  /**
   * Gets the Distribution attribute of the IndexedNthOrderDistribution object
   *
   * @param sym a symbol
  ...
  /**
   * Retrieve all of the distributions that are conditioned upon the conditioning distributions.
   *
