 ...
 *
 * <p>
 * This decouples programs from needing to know what implementation of Distribution to instantiate
 * for a given alphabet. It also lets you parameterise model creation for things like profile HMMs.
 * </p>
 *
...
public interface DistributionFactory {
   ...
   * @throws IllegalAlphabetException if the factory is unable to generate a distribution for the
   *         required alphabet
   */
   ...
   *
   * <p>
   * You may wish to alias this within your scripts with something like: DistributionFactory dFact =
   * DistributionFactory.DEFAULT; dFact.createDistribution(...);
   * </p>
   */
   ...
   *
   * <p>
   * It knows about hand-optimized implementations for some alphabets (like DNA) without the
   * optimized classes needing to be exposed from the DP package.
   * </p>
   *
   * @author Matthew Pocock
   */
