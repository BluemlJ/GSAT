...
public class IndexedAnnotationDB implements AnnotationDB {
   ...
   */
  public IndexedAnnotationDB(String dbName, File storeLoc, Index2Model model, List toIndex,
      int maxKeyLen, AnnotationType schema, ParserListenerFactory plFactory)
   ...
   * @since 1.3
   */
  public static interface ParserListenerFactory extends Serializable {
    /**
  ...
  public static class StaticMethodRPFactory implements ParserListenerFactory {
     ...
     * @throws IllegalArgumentException if the Method is not statically scoped, or does not return a
     *         ParserListener or take a single argument of type TagValueListener
     */
    public StaticMethodRPFactory(Method method) throws IllegalArgumentException {
      ...
      if (method.getParameterTypes().length != 1
        ...
        throw new IllegalArgumentException(
            "Method must accept a single TagValueListener as it's sole parameter");
      }
