...
/**
 * Provides the mechanism whereby a ChromatogramGraphic can display a Chromatogram with a non-linear
 * horizontal scale.
 *
...
public interface ChromatogramNonlinearScaler {
   ...
   */
  public float scale(Chromatogram c, int sampleIndex) throws IndexOutOfBoundsException;
