...
// ParseErrorSource
{
  ...
  public static class Factory implements SequenceBuilderFactory, Serializable {
    ...
    public Factory(SequenceBuilderFactory delegateFactory, TaxonFactory taxonFactory,
        TaxonParser taxonParser, String sciNameKey, String commonNameKey, String ncbiTaxonKey) {
    ...
    public SequenceBuilder makeSequenceBuilder() {
      return new OrganismParser(delegateFactory.makeSequenceBuilder(), taxonFactory, taxonParser,
          sciNameKey, commonNameKey, ncbiTaxonKey);
    }
  }
  ...
  public OrganismParser(SequenceBuilder delegate, TaxonFactory taxonFactory,
      TaxonParser taxonParser, String sciNameKey, String commonNameKey, String ncbiTaxonKey) {
    super(delegate);
    this.taxonFactory = taxonFactory;
    this.taxonParser = taxonParser;
