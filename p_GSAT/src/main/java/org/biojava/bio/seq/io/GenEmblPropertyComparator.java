...
/**
 * <p>
 * <code>GenEmblPropertyComparator</code> compares Genbank/EMBL file format tags by the order in
 * which they should appear in their respective formats.
 * </p>
 *
 * <p>
 * EMBL tags sort before Genbank tags. This is arbitrary. Given the subtle differences in the values
 * accompanying equivalent tags in these formats the two sets shouldn't be mixed anyway.
 * </p>
 *
 * <p>
...
public final class GenEmblPropertyComparator implements Comparator {
  ...
  private GenEmblPropertyComparator() {
    ...
    /*
     * tagOrder.add(EmblLikeFormat.REFERENCE_TAG); tagOrder.add(EmblLikeFormat.COORDINATE_TAG);
     * tagOrder.add(EmblLikeFormat.REF_ACCESSION_TAG); tagOrder.add(EmblLikeFormat.AUTHORS_TAG);
     * tagOrder.add(EmblLikeFormat.TITLE_TAG); tagOrder.add(EmblLikeFormat.JOURNAL_TAG);
     */
