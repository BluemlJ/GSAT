...
/**
 * <code>SimpleSimilarityPairFeature</code> represents a similarity between a query sequence and a
 * subject sequence as produced by a search program.
 *
 * @author Keith James
 * @since 1.2
 */
public class SimpleSimilarityPairFeature extends SimpleStrandedFeature
   ...
   */
  public SimpleSimilarityPairFeature(Sequence sourceSeq, FeatureHolder parent,
      SimilarityPairFeature.Template template) throws IllegalAlphabetException {
  ...
  /**
   * <code>getSibling</code> returns the sibling feature of the pair.
   *
  ...
  public void setSibling(SimilarityPairFeature sibling) throws ChangeVetoException {
    if (hasListeners()) {
      ...
      synchronized (cs) {
        ChangeEvent ce =
            new ChangeEvent(this, SimilarityPairFeature.SIBLING, this.sibling, sibling);
  ...
  /**
   * <code>getAlignment</code> returns the alignment between the two features.
   *
