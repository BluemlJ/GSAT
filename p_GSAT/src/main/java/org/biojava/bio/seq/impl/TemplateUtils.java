...
public final class TemplateUtils {
  ...
  /**
   * This attempts to divine the 'best' template class for a feature and return a new instance
   * readly for pupulating.
   *
   * <p>
   * This will (hopefully) be the most derived feature interface implemented by a feature class.
   * This code assumes that feature interfaces are singly inherited. Of course, with the current
   * template system, it is a fairly safe assumption.
   * </p>
   *
   *
   */
  ...
  /**
   * This attempts to populate the fields of a template using the publically accessible information
   * in a feature. It is simple to call populate() within Feature.makeTemplate() to ensure all the
   * slots get filled.
   *
