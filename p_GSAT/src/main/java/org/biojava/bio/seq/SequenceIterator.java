 ...
 * <p>
 * java.util.Iterator was not appropriate here, as we need specific exceptions to be thrown, and as
 * much type-safety as possible. However, we have made it as compliant with Iterator as we could so
 * that there is a minimal learning curve.
 * 
...
public interface SequenceIterator {
   ...
   * @throws NoSuchElementException if you call nextSequence when hasNext returns false
