 ...
 */
public class AGAVEMrnaHandler extends StAXFeatureHandler

{
  public static final StAXHandlerFactory AGAVE_MRNA_HANDLER_FACTORY = new StAXHandlerFactory() {
   ...
   * 
   * // assume feature set to describe a transcript st.type = "mrna"; st.strand =
   * StrandedFeature.UNKNOWN; // set up annotation bundle st.annotation = new SmallAnnotation();
   * st.location = new Location.EmptyLocation(); if( staxenv != null ) staxenv. subFeatures .add(
   * this ) ;
   * 
   * return st; }
   **/
