...
/**
 * ParseException should be thrown to indicate that there was a problem with parsing sequence
 * information.
 *
...
public class ParseException extends BioException {
   ...
   */
  public static String newMessage(Class format, String accession, String identifier,
      String comments, String parseBlock) {
