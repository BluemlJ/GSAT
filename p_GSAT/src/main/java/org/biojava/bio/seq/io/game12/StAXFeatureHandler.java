 ...
 * individual authors. These should be listed in
 *
 * @author doc comments. For more information on the BioJava project and its aims, or to join the
 *         biojava-l mailing list, visit the home page at: http://www.biojava.org/
 */
 ...
 * greater generality. <strong>NOTE</strong> This class is not thread-safe -- it must only be used
 * for one parse at any time.
 *
 * @author Thomas Down
 * @author David Huen
 * @since 1.2
...
public class StAXFeatureHandler extends StAXContentHandlerBase {
  ...
  /**
   * This base class defines default behaviour for a StAX handler including delegation.
   */
  /**
   * the version of constructor called depends on whether there is an explicit super(...) in the
   * constructor of the derived class. If there is, that specific constructor will be called. If
   * not, the parameterless will is called.
   */
  ...
  /**
   * provides a standardised way of returning an object that represents the result of parsing the
   * child element
   */
