 ...
 */
public abstract class SequenceDBWrapper extends AbstractSequenceDB implements java.io.Serializable {
  ...
  protected class SequencesForwarder extends ChangeForwarder {
    ...
    public ChangeEvent generateEvent(ChangeEvent ce) {
      if (ce.getType() == SequenceDB.SEQUENCES) {
        ...
        if (previous != null) {
          return new ChangeEvent(getSource(), SequenceDB.SEQUENCES, null, previous, ce);
        }
      }
      return null;
    }
