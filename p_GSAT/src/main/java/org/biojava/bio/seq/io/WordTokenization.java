...
/**
 * Base class for tokenizations which accept whitespace-separated `words'. Splits at whitespace,
 * except when it is quoted by either double-quotes ("), brackets (), or square brackets [].
 *
 * @author Thomas Down
 * @author Greg Cox
 * @author Keith James
...
public abstract class WordTokenization extends Unchangeable
    implements
      SymbolTokenization,
      Serializable {
