 ...
 */
public class AGAVESeqFeatureHandler extends StAXFeatureHandler implements AGAVEFeatureCallbackItf

{
   ...
   * 
   * // assume feature set to describe a transcript st.type = "seq_feature"; st.strand =
