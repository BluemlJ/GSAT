 ...
 * @since 1.2
 *
 *        Once you've made one of these and populated it with a few DistDataSource instances, you
 *        should be able to prety much forget about it and use it directly as a normal SequenceDB
 *        implementation.
 *
...
public class DistributedSequenceDB extends AbstractSequenceDB implements SequenceDB {
  public static final ChangeType DATASOURCE = new ChangeType(
      ...
      "org.biojava.bio.seq.distributed.DistributedSequenceDB", "DATASOURCE", ChangeType.UNKNOWN);

  public static final ChangeType DATASOURCE_SELECTION =
      new ChangeType("The set of available data sources has changes in a Distributed Sequence DB",
          "org.biojava.bio.seq.distributed.DistributedSequenceDB", "DATASOURCE_SELECTION",
   ...
   *
   * <p>
   * The returned Set is totaly independant of any future changes made to the distributed sequence
   * DB.
   * </p>
   *
   * @return a new Set containing all DistDataSource instances registered at the time
   */
