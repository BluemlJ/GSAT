...
/**
 * <code>FlatSequenceDBProvider</code> directory-services plugin for flatfile databases.
 *
 * This class is instantiated automatically by the directory-services code, and is not of direct
 * interest to users.
 *
 * @author Keith James
 */
