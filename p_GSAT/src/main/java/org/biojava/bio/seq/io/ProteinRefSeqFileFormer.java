...
/**
 * This class performs the detailed formatting of refseq protein entries. Functionality is
 * essentially identical to GenbankFileFormer except that SimpleFeatures are created intead of
 * StrandedFeatures
 *
 * @author Greg Cox
