...
/**
 * Accept features which are top-level sequence features. This is implemented by the logic that the
 * <code>parent</code> property of top-level features will implement the <code>Sequence</code>
 * interface.
 *
 * @author Thomas Down
 * @since 1.3
...
final class IsTopLevel implements OptimizableFilter {
  ...
  /**
   * All instances are equal (this should really be a singleton, but that doesn't quite fit current
   * </code>FeatureFilter</code> patterns.
   */
