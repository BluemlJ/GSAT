...
/**
 * Simple implementation of the <code>StAXContentHandler</code> interface, with empty
 * implementations for all the methods.
 *
 * <p>
 * This class is provided as a base for content handlers where the implementor does not wish to
