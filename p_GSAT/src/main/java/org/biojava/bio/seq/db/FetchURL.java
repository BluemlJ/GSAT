 ...
 */
/**
 * This class stores base URL and some cgi arguments for accessing web-based sequences in NCBI and
 * Swiss-prot, pubmed articles and locuslinks.
 */
...
public class FetchURL {
  ...
  /**
   * Constructs a fetchURL object based on the database name and specified return format of
   * sequence.
   */
  public FetchURL(String databaseName, String format) {
    ...
    } else if (databaseName.trim().equalsIgnoreCase("genpept")
