...
/**
 * <code>GenpeptFileFormer</code> performs the detailed formatting of Genpept entries for writing to
 * a <code>PrintStream</code>. It is based on GenbankFileFormer.
 * 
...
class GenpeptFileFormer extends AbstractGenEmblFileFormer implements SeqFileFormer {
  ...
  /**
   * Creates a new <code>GenpeptFileFormer</code> using <code>System.out</code> stream.
   */
  ...
  /**
   * Creates a new <code>GenpeptFileFormer</code> using the specified stream.
   *
