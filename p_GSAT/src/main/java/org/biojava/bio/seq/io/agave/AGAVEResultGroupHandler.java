...

{
  ...
  /*
   * protected Feature.Template createTemplate() { // create Gene Template for this Feature.Template
   * st = new Feature.Template();
   * 
   * // assume feature set to describe a transcript st.type = "result_group"; // set up annotation
   * bundle st.annotation = new SmallAnnotation(); st.location = new Location.EmptyLocation(); if(
   * staxenv != null ) staxenv. subFeatures .add( this ) ;
   * 
   * return st; }
   */
