...
public class GAMEAnnotationHandler extends StAXFeatureHandler {
  ...
  private class FeatureSetHandler extends GAMEFeatureSetHandler {
    ...
    public void endElementHandler(String nsURI, String localName, String qName,
        StAXContentHandler contentHandler) throws SAXException {
      // validate
  ...
  private void knownTypesInitialiser() {
    ...
    String[] types = {"gene", "tRNA", "snRNA", "pseudogene", "transposon", "snoRNA",
        "misc. non-coding RNA", "transposable_element", "miscellaneous curator's observation"};
  ...
  public void endElementHandler(String nsURI, String localName, String qName,
    ...
    if (!knownTypes.contains(annotationType)) {
      System.err
          .println("<annotation> of type " + annotationType + " encountered when gene expected");
    }
