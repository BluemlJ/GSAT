...
/**
 * <p>
 * This interface defines mapping from BioJava into AGAVE format. As data from different sources is
 * stored differently in BioJava it is impossible to define universal mapping from BioJava to Agave.
