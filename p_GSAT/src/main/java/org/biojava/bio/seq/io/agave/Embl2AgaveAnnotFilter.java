...
public class Embl2AgaveAnnotFilter extends SimpleAnnotFilter {
  ...
  public String getNote(Annotation annot) {
    return "RN:" + (String) UtilHelper.getProperty(annot, "RN") + "  \n" + "RP:"
        + (String) UtilHelper.getProperty(annot, "RP") + "  \n" + "RA:"
        + (String) UtilHelper.getProperty(annot, "RA") + "  \n" + "RT:"
        + (String) UtilHelper.getProperty(annot, "RT") + "  \n" + "RL:"
        + (String) UtilHelper.getProperty(annot, "RL") + "  \n";
  }
