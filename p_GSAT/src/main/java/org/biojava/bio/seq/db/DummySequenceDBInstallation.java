...
/**
 * <code>DummySequenceDBInstallation</code> is an implementation which returns the same
 * <code>DummySequenceDB</code> instance regardless of the identifier used to retrieve a database.
 *
