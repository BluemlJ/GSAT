...
/**
 * Simple filter which handles attribute lines from an Swissprot entry. Skeleton implementation,
 * please add more functionality.
 *
 * <p>
 * <strong>FIXME:</strong> Note that this is currently rather incomplete, and doesn't handle any of
 * the header information sensibly except for ID and AC.
 * </p>
 *
 * @author Thomas Down
...
public class SwissprotProcessor extends SequenceBuilderFilter implements ParseErrorSource {
   ...
   *
   * @param delegate The sequecence builder to be used in constructing the sequence
