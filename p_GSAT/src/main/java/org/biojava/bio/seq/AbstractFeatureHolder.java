 ...
 *
 * This provides the filter method, but who wants to code that more than once? It also has support
 * for the ChangeEvents.
 *
      ...
      if (recurse) {
        ...
        for (Iterator rf = r.features(); rf.hasNext();) {
          try {
            ...
            throw new BioError("Assertion failure: Should be able to manipulate this FeatureHolder",
                cve);
          }
        }
      }
