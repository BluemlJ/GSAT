...
public class SimpleHomology extends AbstractChangeable implements Homology {
  ...
  /**
   * Creates a new empty <code>SimpleHomology</code> containing no <code>Alignment</code> and no
   * <code>FeatureHolder</code>.
   */
  public SimpleHomology() {}

  /**
   * <code>getFeatures</code> returns the constituent <code>HomologyFeature</code>s which are also
   * used as the keys in the alignment.
   *
  ...
  /**
   * <code>getAlignment</code> returns the alignment, which uses the <code>HomologyFeature</code>s
   * as keys.
   *
  ...
  /**
   * <code>setAlignment</code> sets the alignment which describes the homology. The alignment,
   * should use the <code>HomologyFeature</code>s as keys. A suitable <code>FeatureHolder</code> is
   * automatically created.
   *
   * @param alignment an <code>Alignment</code>.
   *
   * @exception BioException if an error occurs.
   * @exception ChangeVetoException if the <code>SimpleHomology</code> is locked.
   */
  public void setAlignment(Alignment alignment) throws BioException, ChangeVetoException {
    ...
    for (Iterator li = alignment.getLabels().iterator(); li.hasNext();) {
      Object o = li.next();
      if (!HomologyFeature.class.isInstance(o)) throw new BioException(
          "The labels of the Alignment used to construct a SimpleHomology should be the relevant HomologyFeatures");
