 ...
 * @author Greg Cox
 */
public class AGAVEBioSeqHandler extends StAXFeatureHandler
    implements
   ...
   * 
   * // assume feature set to describe a transcript st.type = "bio_sequence"; st.strand =
  ...
  public void endElementHandler(String nsURI, String localName, String qName,
    ...
    try {
      ...
      if (featureTemplate == null) throw new SAXException("feature template is null ");
