...
public class SimpleHomologyFeature extends SimpleStrandedFeature implements HomologyFeature {
  ...
  public SimpleHomologyFeature(Sequence sourceSeq, FeatureHolder parent,
      HomologyFeature.Template template) throws IllegalArgumentException, IllegalAlphabetException {
