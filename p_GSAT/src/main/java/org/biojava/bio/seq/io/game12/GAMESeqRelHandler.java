...
public class GAMESeqRelHandler extends StAXFeatureHandler {
   ...
   */
  public final static StAXHandlerFactory GAME_SEQ_REL_HANDLER_FACTORY = new StAXHandlerFactory() {
  ...
  GAMESeqRelHandler(StAXFeatureHandler staxenv) {
    ...
    super.addHandler(new ElementRecognizer.ByLocalName("span"), new StAXHandlerFactory() {
      public StAXContentHandler getHandler(StAXFeatureHandler staxenv) {
