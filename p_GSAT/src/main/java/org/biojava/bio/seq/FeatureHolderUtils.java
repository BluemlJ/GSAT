...
/**
 * This class intendes to provide some FeatureHolder utilities. Currently it is mainly providing set
 * operators.
 * 
...
public class FeatureHolderUtils {
  ...
  private static FeatureHolder intersectOp(FeatureHolder fh1, FeatureHolder fh2)
      throws ChangeVetoException {
