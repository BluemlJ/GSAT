...
{
  public static final StAXHandlerFactory AGAVE_SEQ_MAP_HANDLER_FACTORY = new StAXHandlerFactory() {
   ...
   * 
   * // assume feature set to describe a transcript st.type = "sequence_map"; st.strand =
