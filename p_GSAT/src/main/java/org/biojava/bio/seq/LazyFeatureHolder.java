...
/**
 * Wrapper implementation of FeatureHolder which calls a method to create a contained FeatureHolder
 * on demand. This is an abstract class and is normally used like:
 *
 * FeatureHolder fh = new LazyFeatureHolder() { protected FeatureHolder createFeatureHolder() {
 * SimpleFeatureHolder features = new SimpleFeatureHolder(); // Create some features in here...
 * return features; } } ; </pre>
 *
 * @author Thomas Down
