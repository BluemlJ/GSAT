 ...
 * <p>
 * This can be wired from a StreamReader to make a simple file-format conversion utility, or can be
 * used to write out the sequences in a database to disk.
 *
 * <p>
 * More functionality is offered by {@link org.biojavax.bio.seq.io.RichStreamWriter
 * RichStreamWriter}, Use of this interface is prefered.
 * </p>
 *
