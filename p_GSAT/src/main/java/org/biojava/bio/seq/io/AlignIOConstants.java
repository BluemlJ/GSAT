...
/**
 * <code>AlignIOConstants</code> contains constants used to identify sequence formats, alphabets
 * etc, in the context of reading and writing alignments.
 *
 * <p>
 ...
 *
 * <ul>
 * <li>The two least significant bytes are reserved for format types such as MSF, CLUSTAL etc.</li>
 *
...
public final class AlignIOConstants {
  /**
   * <code>UNKNOWN</code> indicates that the alignment format is unknown.
   */
  public static final int UNKNOWN = 100;

  /**
   * <code>RAW</code> indicates that the alignment format is raw (symbols only).
   */
  public static final int RAW = 101;

  /**
   * <code>FASTA</code> indicates that the alignment format is Fasta.
   */
  public static final int FASTA = 102;

  /**
   * <code>CLUSTAL</code> indicates that the alignment format is Clustal.
   */
