...
/**
 * Lightweight adaptor which translates SAX content events into StAX form, and provides delegation
 * services.
 *
 * @author Thomas Down
...
public class SAX2StAXAdaptor implements ContentHandler {
  ...
  public void startElement(final String nsURI, final String localName, final String qName,
      final Attributes attrs) throws SAXException {
    S2SDelegationManager dm = new S2SDelegationManager();
    dm.setRecursive(isRecursive);
    current.handler.startElement(nsURI, localName, qName, attrs, dm);
