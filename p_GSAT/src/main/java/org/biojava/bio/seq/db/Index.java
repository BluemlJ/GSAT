...
public interface Index {
  ...
  /**
   * Skipping this number of bytes through the file should put the file pointer to the first byte of
   * the sequence.
   *
  ...
  /**
   * The entry can be slurped out of the file by grabbing length bytes from start. If the length
   * can't be read from a store then this method should return -1.
   * 
