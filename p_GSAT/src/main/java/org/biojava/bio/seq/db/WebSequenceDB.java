...
public abstract class WebSequenceDB extends AbstractChangeable implements SequenceDBLite {
   ...
   * @throws BioException if the io operation times out or has problems connecting. Can also
   *         indicate an invalid URL has been constructed.
   */
  public Sequence getSequence(String id) throws BioException {
    ...
    try {
      ...
      SequenceIterator seqI =
          new StreamReader(connection.getInputStream(), sFormat, rParser, sFact);
