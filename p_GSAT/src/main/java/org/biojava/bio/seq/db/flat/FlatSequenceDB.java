...
/**
 * <code>FlatSequenceDB</code> is an OBDA flatfile sequence databank implementation. It is backed by
 * an index created using the <code>org.biojava.bio.program.indexdb</code> package.
 *
 * @author Keith James
 */
public class FlatSequenceDB extends Unchangeable implements SequenceDBLite {
  ...
  public FlatSequenceDB(String location, String dbName) throws IOException, BioException {
    ...
    try {
      ...
      throw new BioException(
          "Malformed OBDA index '" + location + "' does not indicate sequence format", nsee);
    } catch (LifeScienceIdentifierParseException lse) {
      throw new BioException("Malformed OBDA index '" + location
  ...
  public Sequence getSequence(String id) throws IllegalIDException, BioException {
    try {
      ...
      int formatId = SeqIOTools.identifyFormat(format.getNamespaceId(), format.getObjectId());
      ...
      throw new BioException("Failed to retrieve sequence with ID " + id, ioe);
    }
  }

  /**
   * <code>addSequence</code> always throws a <code>ChangeVetoException</code> as this
  ...
  public void addSequence(Sequence sequence) throws ChangeVetoException {
    throw new ChangeVetoException(
        "Failed to add sequence." + " Sequences may not be added" + " to a flat database");
  }

  /**
   * <code>removeSequence</code> always throws a <code>ChangeVetoException</code> as this
   * implementation is immutable.
   *
  ...
  public void removeSequence(String id) throws ChangeVetoException {
    throw new ChangeVetoException(
        "Failed to add sequence." + " Sequences may not be removed" + " from a flat database");
  }
}
