...
class DistComponentFeature extends Unchangeable implements ComponentFeature {
  ...
  public DistComponentFeature(DistributedSequence parent, ComponentFeature.Template temp)
      throws BioException {
  ...
  public void setSource(String source) throws ChangeVetoException {
    throw new ChangeVetoException(new ChangeEvent(this, TYPE, source, this.source),
  ...
  protected FeatureHolder getProjectedFeatures() {
    if (projectedFeatures == null) {
      projectedFeatures = new ProjectedFeatureHolder(new TranslateFlipContext(this,
          new SubSequence(getComponentSequence(), getComponentLocation().getMin(),
              getComponentLocation().getMax()),
          translation, getStrand() == StrandedFeature.NEGATIVE));
    }
