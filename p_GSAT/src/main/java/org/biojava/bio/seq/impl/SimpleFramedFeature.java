...
public class SimpleFramedFeature extends SimpleStrandedFeature implements FramedFeature, Frame {
  ...
  public SimpleFramedFeature(Sequence sourceSeq, FeatureHolder parent,
      FramedFeature.Template template) throws IllegalAlphabetException {
    ...
    if (sourceSeq.getAlphabet() == RNATools.getRNA() && template.strand == NEGATIVE) {
      throw new IllegalAlphabetException(
          "Cannot create a FramedFeature on the negative strand of an RNA");
