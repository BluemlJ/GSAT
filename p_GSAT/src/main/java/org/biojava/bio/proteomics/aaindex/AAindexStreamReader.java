...
/**
 * Iterator over {@link org.biojava.bio.proteomics.aaindex.AAindex} objects that are stored in a
 * stream in the AAindex1 file format. The format of such an Amino Acid Index Database file is
 * described in the <a href="http://www.genome.ad.jp/dbget-bin/show_man?aaindex">AAindex manual
 * </a>. The {@link #nextTable()} method returns objects of type
 * {@link org.biojava.bio.proteomics.aaindex.AAindex}. See this class also for further informations.
 * To hold an AAindex1 file in memory for random access use the
 * {@link org.biojava.bio.proteomics.aaindex.SimpleSymbolPropertyTableDB} class: <pre>
 ...
 * </p>
 * <p>
 * <a href="http://www.genome.ad.jp/dbget/aaindex.html">AAindex web site</a>.
 * </p>
 * <p>
 * Kawashima, S. and Kanehisa, M.; AAindex: amino acid index database. Nucleic Acids Res. 28, 374
 * (2000).
 * </p>
 * <p>
 * Tomii, K. and Kanehisa, M.; Analysis of amino acid indices and mutation matrices for sequence
 * comparison and structure prediction of proteins. Protein Eng. 9, 27-36 (1996).
 * </p>
 * <p>
 * Nakai, K., Kidera, A., and Kanehisa, M.; Cluster analysis of amino acid indices for prediction of
...
public class AAindexStreamReader implements SymbolPropertyTableIterator {
  ...
  static {
    try {
      ...
      aa = new Symbol[] {tokenizer.parseToken("A"), tokenizer.parseToken("R"),
          tokenizer.parseToken("N"), tokenizer.parseToken("D"), tokenizer.parseToken("C"),
          tokenizer.parseToken("Q"), tokenizer.parseToken("E"), tokenizer.parseToken("G"),
          tokenizer.parseToken("H"), tokenizer.parseToken("I"), tokenizer.parseToken("L"),
          tokenizer.parseToken("K"), tokenizer.parseToken("M"), tokenizer.parseToken("F"),
          tokenizer.parseToken("P"), tokenizer.parseToken("S"), tokenizer.parseToken("T"),
          tokenizer.parseToken("W"), tokenizer.parseToken("Y"), tokenizer.parseToken("V"),};
