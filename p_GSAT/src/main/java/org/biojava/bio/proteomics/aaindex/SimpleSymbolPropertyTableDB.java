...
public class SimpleSymbolPropertyTableDB implements SymbolPropertyTableDB {
  ...
  /**
   * Initializes the database by copying all symbol property tables from a given iterator into the
   * database.
   * 
   * @param tableIterator an iterator over symbol property tables.
   * @throws BioException if the symbol property tables could not be iterated.
   */
  ...
  /**
   * Adds a symbol property table to the database. Overrides an existing table entry with the same
   * name.
   * 
