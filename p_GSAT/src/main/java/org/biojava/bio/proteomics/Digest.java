...
/**
 * This class contains methods for calculating the results of proteolytic digestion of a protein
 * sequence
 *
...
public class Digest {
  ...
  /**
   * Adds peptides as features to the Sequence in this class. The feature will contain a small
   * annotation specifying the protease with the key "protease".
   * 
   * For Example:
   * 
   * <PRE>
