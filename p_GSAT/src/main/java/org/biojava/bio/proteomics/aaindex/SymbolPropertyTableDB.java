...
public interface SymbolPropertyTableDB {
  ...
  /**
   * Returns an iterator over {@link org.biojava.bio.symbol.SymbolPropertyTable} objects.
   * 
   ...
   * 
   * @param name the {@linkplain org.biojava.bio.symbol.SymbolPropertyTable#getName() name of the
   *        table}
