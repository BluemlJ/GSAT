...
public class Protease implements Serializable {
  ...
  protected Protease(SymbolList cleaveRes, boolean endoProtease, SymbolList notCleaveRes,
  ...
  /**
   * @deprecated Creating a Protease with this constructor will not register it with the
   *             ProteaseManager (use ProteaseManager.createProtease())
   */
  ...
  /**
   * Get the list of Protease names defined in the ProteaseManager (Internally calls
   * ProteaseManager.
   * 
  ...
  /**
   * Retrieves a reference to the named Protease. (Internally calls
