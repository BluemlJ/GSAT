...
/**
 * Symbol property table based on the Amino Acid Index Database. Each <code>AAindex</code> object
 * represents a single entry of an AAindex1 file. Each entry contains twenty numeric values for the
 * twenty amino acids, e.g. describing the hydrophobicity of an amino acid. To get this value for a
 * certain amino acid call the
 * {@link org.biojava.bio.symbol.SymbolPropertyTable#getDoubleValue(org.biojava.bio.symbol.Symbol)}
 * method with the appropriate symbol, e.g. <code>aaindex.getDoubleValue(ProteinTools.gln())</code>.
 * The remaining data fields, i.e. object properties, are fully described in the
 * <a href="http://www.genome.ad.jp/dbget-bin/show_man?aaindex">AAindex manual </a>.
 * <p>
 * <b>References:</b>
 * </p>
 * <p>
...
public class AAindex extends SimpleSymbolPropertyTable {
  ...
  /**
   * The alphabet of the symbol property table, that is {@linkplain ProteinTools#getAlphabet()
   * protein}.
   */
   ...
   * 
   * @param accessionNumber the AAindex accession number (same as the table name)
   * @throws NullPointerException if <code>accessionNumber</code> is <code>null</code>.
   */
   ...
   * 
   * @param description a human readable description. May be <code>null</code>.
   */
  ...
  public String[] getLITDBEntryNumbers() {
    return (litdbEntryNumbers == null ? null : (String[]) litdbEntryNumbers.clone());
  }
   ...
   * 
   * @return a map which keys are the names of the similar AAindex entries and which values are the
