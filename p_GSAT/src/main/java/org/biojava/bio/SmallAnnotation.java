...
/**
 * Annotation that is optimized for memory usage. Access time is linear, so SmallAnnotations are not
 * recommended when the number of entries is large. However, they are fine for small numbers of
 * keys.
 *
 * @author Thomas Down
 ...
 *
 * 
 *        When creating a large number of small Annotation instances, it is worth instantiating
 *        SmallAnnotation. Small is anything up to at least 30 properties but will vary with the
 *        JavaVM and underlying platform.
 */
