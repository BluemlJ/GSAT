...
/**
 * <code>AnnotationRenamer</code> remaps the keys of an <code>Annotation</code> to new keys
 * specified by a <code>TagMapper</code>. This will rename properties, but not alter their values.
...
public class AnnotationRenamer extends AbstractAnnotation {
  ...
  /**
   * Creates a new <code>AnnotationRenamer</code> using the specified <code>TagMapper</code> to
   * remap its keys.
   *
  ...
  /**
   * <code>getMapper</code> returns the <code>TagMapper</code> being used to remap the
  ...
  /**
   * <code>propertiesAllocated</code> Javadoc FIXME - this overrides a protected method and I'm not
   * sure why (KJ).
   *
