 ...
 *
 * <p>
 * It is left up to the impementor to provide methods for accessing the parent and children. All
 * other state is provided for here. A common pattern would be to route any Taxon.getParent() call
 * back via a method on the TaxonFactory used to generate this instance.
 * </p>
 *
...
public abstract class AbstractTaxon extends AbstractChangeable implements Taxon {
  ...
  public void setCommonName(String commonName) throws ChangeVetoException {
    if (this.commonName != null) {
      throw new ChangeVetoException("Common name already set to: " + this.commonName
          + " so you can't set it to: " + commonName);
    }
  ...
  public void setScientificName(String scientificName) throws ChangeVetoException {
    if (this.scientificName != null) {
      throw new ChangeVetoException("Common name already set to: " + this.scientificName
          + " so you can't set it to: " + scientificName);
    }
  ...
  public boolean equals(Object o) {
    if (o instanceof Taxon) {
      ...
      return this == t || (safeEq(this.getScientificName(), t.getScientificName())
