...
public interface TaxonFactory {
   ...
   *
   * <p>
   * The return value of this method should be .equals() and .hasCode() compatable with the taxon
   * parameter. It may not be implemented by the same underlying implementation.
   * </p>
   *
   ...
   *
   * <p>
   * This method is here out of desperation. It's nasty and should be replaced by some propper
   * querying API. Without having different methods for every TaxonFactory I don't know what to do.
   ...
   *
   * <p>
   * The TaxonFactory may chose to add the child directly, or make a new object which is .equals()
   * compatable with child. The actual Taxon instance inserted into the child set is returned by the
   * add method.
   * </p>
   *
   ...
   * @throws CircularReferenceException if child is this Taxon or any of its parents
   */
   ...
   *
   * <p>
   * This Taxon should attempt to remove a child that is .equals() compatable with child. If it is
   * sucessful, it should return the Taxon instance that was removed. If not, it should return null.
   * </p>
   *
   ...
   */
  public Taxon removeChild(Taxon parent, Taxon child) throws ChangeVetoException;
}
