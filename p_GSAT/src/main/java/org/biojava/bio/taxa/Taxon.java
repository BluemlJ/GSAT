 ...
 *
 * <p>
 * Taxa may be 'leaf' nodes specifying species, or 'internal' nodes specifying kingdoms and the
 * like.
 * </p>
 *
...
public interface Taxon extends Annotatable {
   ...
   */
  public final static ChangeType CHANGE_COMMON_NAME =
      new ChangeType("Common name change", Taxon.class, "CHANGE_COMMON_NAME");

  /**
   * Change type to indicate that the scientific name of this Taxon is changing.
   */
  public final static ChangeType CHANGE_SCIENTIFIC_NAME =
      new ChangeType("Scientific name change", Taxon.class, "CHANGE_SCIENTIFIC_NAME");
   ...
   *
   * <p>
   * This will be the portion of the scientific classification pertaining to just this node within
   * the classifictaion. It will be something like 'homo sapiens' or 'archaeal group 2', rather than
   ...
   * @throws ChangeVetoException if the scientific name can't be changed at this time
   */
   ...
   *
   * <p>
   * Taxa live within a tree data-structure, so every taxon has a single parent except for the root
   * type. This has the null parent.
   * </p>
   *
   ...
   *
   * <p>
   * Taxa live within a tree data-structure, so every taxon has zero or more children. In the case
   * of zero children, the empty set is returned.
   * </p>
   *
   * <p>
   ...
   *
   * <p>
   * Two different implementations of Taxon should be able to appropriately trans-class equality.
   * The parent of a Taxon is not considered in testing equality as this potentially leads to
   * combinatorial problems checking whole taxa hierachies against one another.
   * </p>
   *
   * @param o the object to check
   * @return true if o is a Taxon instance and has the same properties as this
   */
