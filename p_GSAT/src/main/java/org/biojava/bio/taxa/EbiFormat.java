...
/**
 * Encapsulate the 'EBI' species format used in Embl, Genbank and Swissprot files. The Taxon objects
 * created by this process have the following annotations:
 * <p>
 *
 * <pre>
...
public class EbiFormat implements TaxonParser {
  ...
  public Taxon parse(TaxonFactory taxonFactory, String taxonString)
    ...
    String tok = null;
    CLIMB_TREE: while (sTok.hasMoreTokens()) {
