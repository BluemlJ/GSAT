...
/**
 * Computes composition statistics about a <code>SymbolList</code>. Essentially a conveniece wrapper
 * around a Distribution.
 * 
...
public class Composition {
   ...
   * @throws org.biojava.bio.symbol.IllegalSymbolException if <code>symbolList</code> is not DNA.
   */
  public synchronized void setSymbolList(final SymbolList symbolList)
