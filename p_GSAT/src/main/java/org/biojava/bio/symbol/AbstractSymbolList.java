...
/**
 * <p>
 * Abstract helper implementation of the SymbolList core interface. To produce a concrete SymbolList
 * implementation, you need only implement the <code>getAlphabet</code>, <code>length</code> and
 * <code>symbolAt</code> methods. Iterators and sublists are handled for you automatically.
 * </p>
 * 
 * <p>
 * This class makes many custom SymbolList implementations very quick to implement. See
 * org.biojava.bio.seq.tools.ComplementSymbolList for an example of this.
 * </p>
 * 
 * <p>
 * To make a mutable SymbolList, override the implementation of edit to perform the apropreate edit.
 * If your implementation of SymbolList is a view onto an underlying SymbolList, then you must
 * forward any apropreate edit requests to that list, and forward all events from the underlying
 * list to your listeners.
 * </p>
 * 
 * @author Thomas Down
...
public abstract class AbstractSymbolList extends AbstractChangeable implements SymbolList {
   ...
   * 
   * <p>
   * Objects of this type are returned by <code>AbstractSymbolList.iterator</code>.
   * </p>
   * 
   * @author Thomas Down
   */
  ...
  private class SymbolIterator implements Iterator<Symbol>, Serializable {
    ...
    /**
     * Construct a SymbolIterator object that will return the symbols from min to max inclusive.
     * 
   ...
   * 
   * <p>
   * Objects of this type are instantiated by <code>AbstractSymbolList.subList</code>.
   * </p>
   * 
   * @author Thomas Down
   * @author Matthew Pocock
  ...
  private class SubList<T extends Symbol> extends AbstractChangeable
    ...
    public Symbol symbolAt(int pos) {
      if (pos < 1 || pos > length()) {
        throw new IndexOutOfBoundsException("Symbol index out of bounds " + length() + ":" + pos);
      }
    ...
    public void edit(Edit edit) throws IllegalAlphabetException, ChangeVetoException {
      AbstractSymbolList.this
          .edit(new Edit(edit.pos + this.start - 1, edit.length, edit.replacement));
    }

    protected ChangeSupport getChangeSupport(ChangeType changeType) {
      ChangeSupport cs = super.getChangeSupport(changeType);

      if ((SymbolList.EDIT.isMatchingType(changeType) || changeType.isMatchingType(SymbolList.EDIT))
          && (editTranslater == null)) {
    ...
    public String toString() {
      return super.toString() + " start: " + start + " end: "
          + end /*
                 * (+ " parent: " + AbstractSymbolList . this. toString () [causes infinite loop --
                 * odd]
                 */;
    }
  }
   ...
   * 
   * <p>
   * Objects of this type are instantiated by <code>AbstractSymbolList.asList</code>.
   * </p>
   * 
   * @author Thomas Down
   */

  private static class ListView<T extends Symbol> extends AbstractList<T> implements Serializable {
    /**
     * Generated serial version identifier.
     */
  ...
  /**
   * This adapter screens all edit events to see if they overlap with a window of interest. If they
   * do, then a new edit event is built for the overlapping region and pased on to all listeners.
   * 
   * @author Matthew Pocock
   */
  ...
  public class EditTranslater extends EditScreener {
    ...
    protected ChangeEvent generateEvent(ChangeEvent ce) {
      ...
      if (ce != null) {
        ...
        return new ChangeEvent(ce.getSource(), ce.getType(),
            new Edit(edit.pos - min, edit.length, edit.replacement), null, ce.getChainedEvent());
      }
      return null;
    }
  }
