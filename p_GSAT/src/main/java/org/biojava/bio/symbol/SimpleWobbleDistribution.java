 ...
 * @since 1.3
 */
class SimpleWobbleDistribution implements WobbleDistribution {
  Symbol residue;
  Set nonWobbleBases;
  Distribution nonWobbleDist;
  Map wobbleDist;

  SimpleWobbleDistribution(Symbol residue, Set nonWobbleBases, Distribution nonWobbleDist,
      Map wobbleDist) throws NullPointerException, IllegalAlphabetException {
    if ((residue == null) || (nonWobbleBases == null) || (nonWobbleDist == null)
        || (wobbleDist == null))
