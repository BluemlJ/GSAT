...
public interface SymbolList extends Changeable {
  /**
   * Signals that the SymbolList is being edited. The getChange field of the event should contain
   * the SymbolList.Edit object describing the change.
   */
  public static final ChangeType EDIT =
      new ChangeType("the SymbolList has been edited", "org.biojava.bio.symbol.SymbolList", "EDIT");

  /**
   * The alphabet that this SymbolList is over.
   * <p>
   * Every symbol within this SymbolList is a member of this alphabet.
   * <code>alphabet.contains(symbol) == true</code> for each symbol that is within this sequence.
   *
   * @return the alphabet
   */
