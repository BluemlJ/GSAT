...
abstract class AbstractSimpleBasisSymbol extends SimpleSymbol implements BasisSymbol {
  protected List symbols;

  protected AbstractSimpleBasisSymbol(Annotation annotation, List symbols)
  ...
  public AbstractSimpleBasisSymbol(Annotation annotation, List symbols, Alphabet matches)
      throws IllegalSymbolException {
