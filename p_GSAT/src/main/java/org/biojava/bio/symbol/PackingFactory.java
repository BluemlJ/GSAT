...
/**
 * <p>
 * A factory that is used to maintain associations between alphabets and preferred bit-packings for
 * them.
 * </p>
 *
 * <p>
 * There are many ways to pack the symbols for an alphabet as binary. Different applications will
 * wish to have different representations for reasons such as integration with external formats,
 * whether to store ambiguity or not and what algorithms may be used on the bit-packed
 * representation. Also, it has utility methods to arrange the bit-strings for symbols within a Java
 * int primitive.
 * </p>
 *
...
public class PackingFactory {
   ...
   * @param ambiguity true if the packing should store ambiguity and false if it can discard
   *        ambiguity information
   * @throws IllegalAlphabetException if this combination of alphabet and ambiguity can not be
   *         handled
   **/
  ...
  public static int nextWord(SymbolList symList, int word, int offset, int wordLength,
      Packing packing) throws IllegalSymbolException {
