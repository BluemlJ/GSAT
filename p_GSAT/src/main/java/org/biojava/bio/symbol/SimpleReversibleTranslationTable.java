 ...
 */
public class SimpleReversibleTranslationTable extends AbstractReversibleTranslationTable
    implements
      Serializable {
  ...
  public SimpleReversibleTranslationTable(FiniteAlphabet source, FiniteAlphabet target)
    ...
    if (source.size() != target.size()) {
      throw new IllegalAlphabetException(
          "Couldn't create translation table as " + "the alphabets were different sizes: "
              + source.size() + ":" + source.getName() + target.size() + ":" + target.getName());
    }
