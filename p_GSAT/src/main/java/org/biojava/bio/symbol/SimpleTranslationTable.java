...
/**
 * A no-frills implementation of TranslationTable that uses a Map to map from symbols in a finite
 * source alphabet into a target alphabet.
 *
...
public class SimpleTranslationTable extends AbstractTranslationTable implements Serializable {
   ...
   * @throws IllegalSymbolException if either from is not in the source alphabet or to is not in the
   *         target alphabet
   */
   ...
   * <p>
   * The source alphabet must be finite, as a Map object is used to associate a source Symbol with a
   * target Symbol. The target alphabet need not be finite.
   *
   ...
   * Create a new translation table that will translate symbols from source to target.
   * <p>
   * The Map transMap should contain keys in the source alphabet with values in the target alphabet.
   * However, this is not currently checked.
   * <p>
   * The source alphabet must be finite, as a Map object is used to associate a source Symbol with a
   * target Symbol. The target alphabet need not be finite.
   *
