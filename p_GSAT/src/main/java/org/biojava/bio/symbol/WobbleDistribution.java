...
/**
 * an object to return statistics about the frequency of the wobble base in a set of synonymous
 * codons.
 *
 * @author David Huen
 * @since 1.3
...
public interface WobbleDistribution {
  ...
  /**
   * returns the frequency of a specific wobble base in a set of synonymous codons that start with
   * the same two bases. (sums to one over this set).
   */
