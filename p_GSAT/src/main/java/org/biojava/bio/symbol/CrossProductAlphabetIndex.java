...
class CrossProductAlphabetIndex extends AbstractChangeable
  ...
  /**
   * This just takes the alphabet, and splits it up into its sub alphabets then gets an
   * AlphabetIndex for each sub alphabet and stores that in an List. This list is then used for the
   * index computation
   */
