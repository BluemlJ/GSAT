...
public final class SymbolListViews {
   ...
   * <p>
   * In practice, what this means is that you can view a DNA sequence into an overlapping
   * dinucleotide sequence without having to do any work yourself.
   * </p>
   *
   ...
   * <p>
   * In practice, what this means is that you can view a DNA sequence as codons which do not
   * overlap.
   * </p>
   *
   * @param source The underlying SymbolList to view
   ...
   * <p>
   * This method allows you to translate from one alphabet into another, so for example, you could
   * translate from DNA-triplets into amino-acids. You could also translate from DNA-dinucleotide
   * into the 'twist' structural metric, or any other translation that takes your fancy.
   * </p>
   * <p>
   * The actual mapping from source to view Symbol is encapsulated in a TranslationTable object.
   * </p>
   * <p>
   * The translated SymbolList will be the same length as the source, and each Symbol in the view
   * will correspond to a single Symbol in the source.
   * </p>
   *
  ...
  public static SymbolList translate(SymbolList symbols, TranslationTable table)
      throws IllegalAlphabetException {
   ...
   *
   * @param labels a List of labels, which should be the same length as the order
   *        <code>symList</code>'s Alphabet.
  ...
  /**
   * View a portion of a SymbolList. Unlike SymbolList.subList, this method is guarenteed to return
   * a view, which will change when the underlying SymbolList is modified.
   *
