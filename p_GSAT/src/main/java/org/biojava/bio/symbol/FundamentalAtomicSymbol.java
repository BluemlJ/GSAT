...
/**
 * An atomic symbol consisting only of itself. This is the fundamental type of symbol, and needs a
...
public class FundamentalAtomicSymbol extends AbstractSymbol implements AtomicSymbol, Serializable {
  ...
  public FundamentalAtomicSymbol(String name, Annotation annotation) {
    this.name = name;
