 ...
 *
 * <p>
 * This Term type has an associated ontology. It is meant to represent that ontology so that you can
 * reason over them. For example, you could add information to an Ontology containing an
 * OntologyTerm stating how the OntologyTerm's Ontology relates to other entities. This allows
 * classifications of Ontologies to be built. You could say that GO is a biological ontology, as is
 * SO or perhaps declare something about the source of the information.
 * </p>
 *
 * @author Thomas Down
...
public interface OntologyTerm extends Term {
  ...
  public final static class Impl extends AbstractChangeable
      implements
        OntologyTerm,
    ...
    public ChangeSupport getChangeSupport(ChangeType ct) {
      ...
      forwarder = new ChangeForwarder(this, cs) {
        protected ChangeEvent generateEvent(ChangeEvent cev) {
          return new ChangeEvent(getSource(), ChangeType.UNKNOWN, target, null, cev);
        }
      };
