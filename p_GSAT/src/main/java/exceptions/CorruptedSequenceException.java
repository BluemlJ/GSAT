...
/**
 * An instance of this class is thrown if a char, which is not one of 'A', 'T',
 * 'C' or 'G', is detected in a sequence.
 * 
 * @author Ben Kohr
 */
public class CorruptedSequenceException extends Exception {
	...
	/**
	 * Constructor specifies the position, the type of wrong character in an
	 * observed sequence and the nucleotide String. It also specifies an error
	 * message.
	 * 
	 * @param i
	 *            The index of the wrong character
	 * @param problem
	 *            The wrong character
	 * @param nucleotides
	 *            The nucleotide String which is corrupted
	 * 
	 * @author Ben Kohr
	 */
