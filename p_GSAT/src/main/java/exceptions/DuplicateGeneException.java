...
/**
 * This exception is thrown when the user tries to add a gene whose name already
 * exists in the gene file.
 * 
...
public class DuplicateGeneException extends Exception {
	 ...
	 * 
	 * @param name
	 *            The name of the gene which is already in the gene file.
	 * 
	 * @author lovisheindrich
	 */
