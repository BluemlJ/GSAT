...
/**
 * An instance of this class indicates that the similarity of the gene that fits
 * best to a given sequence is very low.
 * 
 * @author Ben Kohr
 */
public class DissimilarGeneException extends Exception {
	 ...
	 * 
	 * @param toAnalyse
	 *            Sequence with a low-fitting-quality gene found
	 * @param bestGene
	 *            The gene for this sequence with a low similarity
	 * @param similarity
	 *            The similarity rate
	 * 
	 * @author Ben Kohr
	...
	public DissimilarGeneException(AnalysedSequence toAnalyse, Gene bestGene, double similarity) {
		super("Best found gene for given sequence (" + bestGene.getName() + ") has a similarity of only " + similarity
				+ " for the given sequence (file: " + toAnalyse.getFileName() + ").");
