...
public class AnalyzedSequence extends Sequence {
	...
	/**
	 * y-Coordinates for four nucleotides corresponding to the x-Value of the
	 ...
	 * @param aTrace
	 */
	public AnalyzedSequence(String sequence, String addingDate, String researcher, String fileName, String comments,
