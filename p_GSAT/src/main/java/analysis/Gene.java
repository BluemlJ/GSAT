...
public class Gene extends Sequence {
	...
	/**
	 * Constructor setting all given attributes (by calling the super
	 * constructor).
	 * 
	 * @param sequence
	 ...
	 * @param researcher
	 *            the name of the researcher who added this gene
	 * 
	 * @author Ben Kohr
	 */
	 ...
	 *            The name of the gene
	 * @param organism
	 *            Name of the organism (more information)
	 * @param comment
	 *            a comment about this specific gene sequence
	 * @param researcher
	 *            the name of the researcher who added this gene
	 * 
	...
	public Gene(String sequence, int id, String name, String researcher, String organism, String comment, Date date) {
