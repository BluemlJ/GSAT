...
/**
 * This class models an abstract DNA sequence which could be a reference gene or
 * a given mutated sequence to analyze. It encapsulates the shared behavior of
 * genes and sequences under analysis.
 * 
...
public abstract class Sequence {
	...
	/**
	 * The date at which this sequence was created. Useful to find out when a
	...
	/**
	 * The sequence of nucleotides, encoded as a String. It consists of the
	 * letters A, C, T, G for the four possible nucleotides adenine, cytosine,
	 * thymine and guanine.
	 */
	protected String sequence;

	/**
	 * Creates a new Sequence object. As an abstract class, only inheriting
	 * classes can be created via this constructor. It sets the nucleotide
	 * sequence and the researcher's name as passed via the parameters.
	 * Furthermore, it determines the current date and stores internally.
	 * 
	 * @param sequence
	 *            the sequence of nucleotides
	 * @param researcher
	 *            the name of the analyzing researcher
	 * 
	 * @author Ben Kohr
	 */
	...
	/**
	 * Returns the complementary version of this object's nucleotide sequence,
	 * i.e. all A nucleotides in the original sequence are replaced with T
	 * nucleotides (and vice versa) and all C nucleotides are replaced by G
	 * nucleotides (and vice versa).
	 * 
	 * @return The complementary nucleotide sequence as a String
	 * 
	 * @throws CorruptedSequenceException
	 *             If a nucleotide letter different from A, T, C and G is
	 *             observed
	 * 
	 * @author Ben Kohr
	 */
	...
	/**
	 * Returns the reversed version of this object's nucleotide sequence, i.e.
	...
	/**
	 * This methods sets the internal nucleotide representation as a String
	 * constisting of the letters A, T, C and G. It also removes all internal
	 * whitespace characters and converts in to uppercase.
	 * 
	 * @param sequence
	 *            The nucleotide sequence to store in the object
	 * 
	 * @author Ben Kohr
	 */
	 ...
	 * 
	 * @return the nucleotide sequence String (as a represenation of this
	 *         object)
	 * 
	 * @author Kevin Otto
	 */
