...
public class QualityAnalysis {
	...
	/**
	 * this parameter sets the average quality to calculate the quality of the
	 * whole sequence. This can be changed by the user. The default value is 30.
	 * 
	 * @see io.ConfigHandler
	 * @see gui.ParameterWindow
	 */
	...
	/**
	 * This method is called before analysing a sequence but after the trimming
	 * them. It checks if any 'X' are in the trimmed sequence. This would mean
	 * the sequence is corrupt and cant be analysed.
	 * 
	 * @see analysis.MutationAnalysis
	 * @param toAnalyse
	 *            the sequence to check if there is any corrupt nucleotide.
	 * @throws CorruptedSequenceException
	 *             if there is any corruption then throw this exception.
	 * @author jannis blueml
	 */
	public static void checkIfSequenceIsClean(AnalysedSequence toAnalyse) throws CorruptedSequenceException {
	...
	/**
	 * This method checks the nucleotide string and finds a position to trim the
	 * low quality part at the end of the sequence.
	 * 
	 * @param sequence
	 *            the sequence getting from the abi file
	...
	/**
	 * This method provides an additional quality measurement by detecting
	 * substrings with an average low quality.
	 * 
	 * @param qualities
	 *            the sequence which needs to be trimmed
	 * @param startPosition
	 *            the first array index which will be used
	 ...
	 * 
	 * @param lengthBefore
	 *            this gives the length before the sequence is trimmed.
	 * @param toAnalyse
	...
	/**
	 * Get average Quality in a score between 0 and 100 by getting all phread
	 * scores and setting them in the phread function.
	 * 
