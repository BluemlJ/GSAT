...
public class VectorTrimTests {
	...
	/**
	 * returns a rendom nucleotide (as char) 0 = A 1 = T 2 = C 3 = G everything
	 * else will result in an error 'e'
	 * 
	 * @param id
	 * @return
	 */
	...
	/**
	 * randomly mutates the given sequence in range from begin to and it puts up
	 * to 10 mutation into one sequence
	 * 
	 * @param sequence
	 * @param begin
	 * @param end
	...
	public void trimVectorDamagedBeginTest() {
		...
		Gene gen = new Gene("hallo3wieGehts3dirheute3heuheuheuheuheuheuheuheuheuheuheuheu", 0, null, null);
