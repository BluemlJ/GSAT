...
public class DatabaseTests {
	...
	private static DatabaseEntry[] entries = new DatabaseEntry[] {
			new DatabaseEntry("a.ab1", 1, "ATCGTCGATCGA", "2016-11-28", "Klaus Bohne", "No comments", "CCCCCCCC",
					"ATCG", true, "+1H4", MutationType.INSERTION),
			new DatabaseEntry("b.ab1", 4, "TCGATCGATCG", "2016-11-28", "Kurt Bohne", "No comments", "TTTTTT", "ATCG",
					false, "-1H4", MutationType.DELETION),
			new DatabaseEntry("c.ab1", 0, "ATCGA", "2016-11-28", "Klaus Bohne", "No comments", "AAAAAAAT", "ATCG", true,
					"ACC4ACG", MutationType.SILENT),
			new DatabaseEntry("d.ab1", 7, "ATCGT", "2016-11-28", "Kurt Bohne", "No comments", "AAAAAAAT", "ATCG", false,
					"H4D", MutationType.SUBSTITUTION),
			new DatabaseEntry("e.ab1", 1, "AA", "2016-11-28", "Kurt Bohne", "No comments; nothing to say", "GGGGGG",
