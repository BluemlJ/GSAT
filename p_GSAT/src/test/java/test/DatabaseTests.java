...
/**
 * This class tests the behavior of the communication with the database and all associated
 * behavior.
 * 
 * @author Ben Kohr
 *
...
public class DatabaseTests {
	 ...
	 * 
	 */
	static AnalyzedSequence seq1 = new AnalyzedSequence("ATCG", "sequence1.ab1", "primer1");
	
	
	/**
	 * The second sequence for testing the conversion method.
	 */
	static AnalyzedSequence seq2 = new AnalyzedSequence("CCCCC", "sequence2.ab1", "primer2");
	
	
	/**
	 * The third test sequence (which will result in no DatabaseEntries).
	 */
	static AnalyzedSequence seq3 = new AnalyzedSequence("A", "sequence3.ab1", "primer3");
	
	
	/**
	 * The fourth test sequence.
	 */
	static AnalyzedSequence seq4 = new AnalyzedSequence("GGG", "sequence4.ab1", "primer4");
	
	
	/**
	 * An array of DatabaseEntries used to test the writing of a file.
	 */
	static DatabaseEntry[] entries = new DatabaseEntry[]{
			new DatabaseEntry("a.ab1", "FSA", "primer1", "A|34|E", false),
	...
	/**
	 * This method sets the genes and adds a few mutations 
	 * to the AnalyzedSequence objects to make them
	 * ready to be used in the tests.
	 * 
	 * @see AnalzedSequence
	 * 
	 * @author Ben Kohr
	...
	/**
	 * This method resets the state of the DatabaseConnection before 
	 * a new test starts to get equal test circumstances.
	 * 
	 * @author Ben Kohr
	 * 
	 */
	...
	public void testStoreAllLocallyNormal() throws MissingPathException, IOException {
		...
		String[] correctResults = new String[]{
				    "0; a.ab1; FSA; primer1; A|34|E; false",
					"1; b.ab1; FSA; primer2; A|7|B; true",
					"2; c.ab1; TEST; primer3; Q|5|R; true",
					"3; d.ab1; TEST; primer4; A|3|R; false",
					"4; e.ab1; TEST; primer5; E|55|O; false"
		}; 
	...
	/**
	 * 
	 * This test checks if there is no problem with the writing even if there are no 
	 * database entries given
	 * 
	 * @throws MissingPathException
	 * @throws IOException
	 * 
	...
	/**
	 * 
	 * This test checks if a MissingPathException is thrown if the writing path is
	 * missing.
	 * 
	 * @throws MissingPathException
	 * @throws IOException
	 ...
	 * This means, this test checks the complete local storage mechanism 
	...
	public void testConvertAndStore() throws MissingPathException, IOException {
		...
		// Check whether the input is correct
		String[] correctResults = new String[]{
				    "0; sequence4.ab1; FSD; primer4; D|23|E; false",
