...
public class ConfigTests {
	 ...
	 */
	@Test
	public void testAnalysedSeqRead() throws IOException, ConfigReadException, ConfigNotFoundException {
		File path = new File("resources/lh_config");
		Config.setPath(path.getAbsolutePath());
		Config.readConfig();
		AnalysedSequence testSeq = new AnalysedSequence("atg", Config.researcher, "seq1.abi",
				new int[] { 100, 100, 100 });
