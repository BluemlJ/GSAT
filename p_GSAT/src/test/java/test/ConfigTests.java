...
public class ConfigTests {
	...
	/**
	 * Test reading a researcher name from a sample config file and sets the
	 * researcher in an analysed sequence (Userstory 017 - Expected behavior)
	 * 
	 * @throws IOException
	 ...
	 */
	@Test
	public void testAnalysedSeqRead() throws IOException, UnknownConfigFieldException, ConfigNotFoundException {
		...
		AnalysedSequence testSeq = new AnalysedSequence("atg", ConfigHandler.getResearcher(), "seq1.abi",
				new int[] { 100, 100, 100 });
		assertEquals(testSeq.getResearcher(), "lovis heindrich");
	}

	/**
	 * Test reading a researcher name from a sample config file (Userstory 017 -
	 * Expected behavior)
	 * 
	 * @throws IOException
	 * @throws UnknownConfigFieldException
	...
	/**
	 * Tests if trying to read a corrupt config file leads to a
	 * ConfigReadException (Userstory 017 - Unusual behavior)
	 * 
	 * @throws IOException
	 * @throws ConfigNotFoundException
	 */
	...
	/**
	 * This tests tries to read from a file that doesn't exist (Userstory 017 -
	 * Unusual behavior)
	 * 
	 * @throws IOException
	 * @throws UnknownConfigFieldException
	...
	/**
	 * Test reading multiple researchers from a sample config file (Userstory
	 ...
	 */
	@Test
	public void testMultipleUsersConfigRead() throws IOException, UnknownConfigFieldException, ConfigNotFoundException {
		ConfigHandler.setResearcher(null);
	...
	@Test
	public void testQualityParameter() throws UnknownConfigFieldException, ConfigNotFoundException, IOException {
		// read config
		File path = new File("resources/lh_config/config.txt");
		ConfigHandler.setPath(path.getAbsolutePath());
		ConfigHandler.readConfig();
	...
	/**
	 * This test checks if it is possible to add a researcher to the researchers
	 * array
	 */
	@Test
	...
	/**
	 * This test checks if it is possible to delete a researcher from the
	 * researchers array
	 */
	@Test
