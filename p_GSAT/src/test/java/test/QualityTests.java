...
public class QualityTests {
    ...
    /**
     * Tests if the quality information is accessible (Userstory 008 - Expected
     * behavior)
     */
    @Test
	 ...
	 * testSequence.length()); System.out
	 * .println("Anfang der hohen Qualitaet: " +
	 * QualityAnalysis.findLowQuality(testSequence)[0]); System.out
	 * .println("Ende der hohen Qualitaet " +
     ...
     * (Userstory xxx - Expected Behavior)
     */
    @Test
     ...
     * would not have been detected by findLowQuality (Userstory xxx - Expected
     * Behavior)
     */
    @Test
     ...
     * (normal findLowQuality will handle it) (Userstory xxx - Unusual Behavior)
     */
    @Test
    ...
    /**
     * This tests checks if the average Quality calculation is correctly
     * integrated in findLowQuality by using testAverageQualityTrimB (Userstory
