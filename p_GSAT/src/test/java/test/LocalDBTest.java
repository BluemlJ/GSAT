...
public class LocalDBTest {
	...
	public void testPullCustom() throws DatabaseConnectionException, SQLException, UnknownConfigFieldException, ConfigNotFoundException, IOException {
		...
		AnalysedSequence s1 = new AnalysedSequence(g1, m1, "seq1", "atatat", d1, "Lovis Heindrich", "comment1", false,
				"primer1", 80, 0, 99);
		AnalysedSequence s2 = new AnalysedSequence(g2, m1, "seq2", "atatat", d3, "Kevin Otto", "comment1", false,
				"primer1", 80, 0, 99);
		AnalysedSequence s3 = new AnalysedSequence(g1, m1, "seq3", "atatat", d3, "Kevin Otto", "comment1", false,
				"primer1", 80, 0, 99);
		AnalysedSequence s4 = new AnalysedSequence(g1, m1, "seq4", "atatat", d2, "Lovis Heindrich", "comment1", false,
				"primer1", 80, 0, 99);
	...
	public void testPullSequencesPerResearcher() throws SQLException, DatabaseConnectionException {
		...
		ArrayList<AnalysedSequence> lovisSequences = DatabaseConnection
				.pullAllSequencesPerResearcher("Lovis Heindrich");
	...
	@Ignore
	@Test
	public void testPullSequences() throws SQLException, DatabaseConnectionException, UnknownConfigFieldException,
